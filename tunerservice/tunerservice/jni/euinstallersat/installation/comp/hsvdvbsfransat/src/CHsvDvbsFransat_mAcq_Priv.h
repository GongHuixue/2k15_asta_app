#ifndef  _CHSVDVBSFRANSAT_MACQ_PRIV_H
#define  _CHSVDVBSFRANSAT_MACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsFransat_mAcq_Priv::
#include "locals_mAcq.h"

class CHsvDvbsFransat_mAcq_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsFransat_mAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbsFransat_mAcq_Priv,iacqpow);
IHsvDigitalAcquisitionImpl(CHsvDvbsFransat_mAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbsFransat_mAcq_Priv);

public:
CHsvDvbsFransat_mAcq_Priv():i__iacqpow(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsFransat_mAcq_Priv::func,replace,(char *)name,this)
