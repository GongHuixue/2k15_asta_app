#ifndef ICEISTPHOSTRTK2_H
#define ICEISTPHOSTRTK2_H
#include <intfparam.h>
#include <provreq.h>
class ICeIsTpHostRtk2
{
public:
	virtual ~ICeIsTpHostRtk2(){}
...
#define ICeIsTpHostRtk2Impl(Comp,intf)    \
...
class Comp ## _ ## intf : public ICeIsTpHostRtk2 \
{\
private:\
    Comp *m_parent; \
public: \
