#ifndef IAPPAPISATELEMENTARYSTREAMCONTROLEXEX_H
#define IAPPAPISATELEMENTARYSTREAMCONTROLEXEX_H
#include <intfparam.h>
#include <provreq.h>
class IAppApiSatElementaryStreamControlExEx
{
public:
	virtual ~IAppApiSatElementaryStreamControlExEx(){}
	#define IAppApiSatElementaryStreamControlExEx_DefaultPID		((int)0x1fff )
	#define IAppApiSatElementaryStreamControlExEx_DefaultLanguage		((int)-1 )
	...
	virtual AppApiReturnCode PlayIPSubtitlePidEx(int PIDValue,Nat16 CompositionPageId,Nat16 AncilliaryPageId)= 0;
	...
	virtual AppApiReturnCode PlayIPCCPidEx(int PIDValue,Nat8 CurrentLanguageTag)= 0;
	...
	virtual AppApiReturnCode TeletextRatedContentEvent(Bool RatedContent)= 0;
};


#define IAppApiSatElementaryStreamControlExExImpl(Comp,intf)    \
...
virtual AppApiReturnCode intf ## _PlayIPSubtitlePidEx(int PIDValue,Nat16 CompositionPageId,Nat16 AncilliaryPageId);\
...
virtual AppApiReturnCode intf ## _PlayIPCCPidEx(int PIDValue,Nat8 CurrentLanguageTag);\
...
virtual AppApiReturnCode intf ## _TeletextRatedContentEvent(Bool RatedContent);\
class Comp ## _ ## intf : public IAppApiSatElementaryStreamControlExEx \
{\
private:\
    Comp *m_parent; \
public: \
...
virtual AppApiReturnCode PlayIPSubtitlePidEx(int PIDValue,Nat16 CompositionPageId,Nat16 AncilliaryPageId){ return m_parent->intf ## _PlayIPSubtitlePidEx(PIDValue,CompositionPageId,AncilliaryPageId);}\
...
virtual AppApiReturnCode PlayIPCCPidEx(int PIDValue,Nat8 CurrentLanguageTag){ return m_parent->intf ## _PlayIPCCPidEx(PIDValue,CurrentLanguageTag);}\
...
virtual AppApiReturnCode TeletextRatedContentEvent(Bool RatedContent){ return m_parent->intf ## _TeletextRatedContentEvent(RatedContent);}\
};\
