#ifndef  _CHSVEUROPEINSTALLATION_MPEGSORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MPEGSORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mpegsort_Priv::
#include "locals_mpegsort.h"

class CHsvEuropeInstallation_mpegsort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mpegsort_Priv();
...
//Provided interfaces
private:
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mpegsort_Priv,idvbtlitesort);
IHsvPowerImpl(CHsvEuropeInstallation_mpegsort_Priv,impegpow);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mpegsort_Priv);

public:
CHsvEuropeInstallation_mpegsort_Priv():i__idvbtlitesort(this),i__impegpow(this)
{
idvbtlitesort	=	&i__idvbtlitesort;
impegpow	=	&i__impegpow;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mpegsort_Priv::func,replace,(char *)name,this)
