...
#define	RUSSIA_SAT_ID			(EUTELSAT_W4_36E)

#define	INVALID_BOUQUET_ID								(0xFFFF)

#define RUSSIA_BOUQUET_ID 					(0x3000)
...
HomingMuxData RussiaDigitalPackageDetails[NO_OF_HOMING_MUX];
static HomingMuxData s__RussiaDigitalPackageDetails[NO_OF_HOMING_MUX];
...
void module__init(void){
	...
	mPump	=	s__mPump;
	memcpy((void*)RussiaDigitalPackageDetails,(void*)s__RussiaDigitalPackageDetails,sizeof(RussiaDigitalPackageDetails));
...
#ifdef RUSSIA_BOUQUET_ID
#undef RUSSIA_BOUQUET_ID
#endif //RUSSIA_BOUQUET_ID
