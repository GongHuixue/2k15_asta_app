#ifndef  _CHSVDVBTMPEGINSTALLATION_MDIGACQ_PRIV_H
#define  _CHSVDVBTMPEGINSTALLATION_MDIGACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbtMpegInstallation_mdigacq_Priv::
#include "locals_mdigacq.h"

class CHsvDvbtMpegInstallation_mdigacq_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbtMpegInstallation_mdigacq_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionImpl(CHsvDvbtMpegInstallation_mdigacq_Priv,idigacq);
public:
...
public:
CHsvDvbtMpegInstallation_mdigacq_Priv():i__idigacq(this)
{
idigacq	=	&i__idigacq;
module__init();
params__init();
...
#define idigscan_iPresent() (idigscan.Present())
...
#define idigscan_Initialise()	idigscan->Initialise()
#define idigscan_StartInstallation(source,ptc,mode)	idigscan->StartInstallation(source,ptc,mode)
#define idigscan_StopInstallation()	idigscan->StopInstallation()
#define idigscan_StartDigitalScan()	idigscan->StartDigitalScan()
#define idigscan_StartDigitalTuning(frequency)	idigscan->StartDigitalTuning(frequency)
#define idigscan_StopDigitalScan()	idigscan->StopDigitalScan()
#define idigscan_GetNoOfPass()	idigscan->GetNoOfPass()
#define idigscan_GetCurrentPass()	idigscan->GetCurrentPass()
#define idigscan_GetPTCInfo(ptc)	idigscan->GetPTCInfo(ptc)
#define idigscan_StoreWeakSignalInstallationChannel()	idigscan->StoreWeakSignalInstallationChannel()
#define idigscan_GetNumberOfDigitalChannelsFound()	idigscan->GetNumberOfDigitalChannelsFound()
#define idigscan_GetNumberOfDigitalChannelsRemoved()	idigscan->GetNumberOfDigitalChannelsRemoved()
#define idigscan_GetTargetNitType(NetworkId)	idigscan->GetTargetNitType(NetworkId)
#define idigscan_GetCurrentState()	idigscan->GetCurrentState()
#define idigscan_GetSDTType()	idigscan->GetSDTType()
#define idigscan_GetAltTSValues(ONID,TSID)	idigscan->GetAltTSValues(ONID,TSID)
#define idigscan_GetCurTSValues(ONID,TSID)	idigscan->GetCurTSValues(ONID,TSID)
#define idigscan_GetStreamPriority()	idigscan->GetStreamPriority()
#define idigscan_SetStreamPriority(prio)	idigscan->SetStreamPriority(prio)
#define idigscan_SyncComplete()	idigscan->SyncComplete()
#define idigscan_ClearCache()	idigscan->ClearCache()
#define idigscan_GetPLPIds(PLPIds)	idigscan->GetPLPIds(PLPIds)
#define idigscan_GetHierarchyMode()	idigscan->GetHierarchyMode()
#define idigscan_ZiggoGetPTCInfo(ptc,Onid,Tsid)	idigscan->ZiggoGetPTCInfo(ptc,Onid,Tsid)
#define idigscan_ZiggoGetSDTType(Frequency)	idigscan->ZiggoGetSDTType(Frequency)
#define idigscan_GetEpgBarkerMux(ONID,TSID)	idigscan->GetEpgBarkerMux(ONID,TSID)
#define idigscan_ZiggoNetworkDataSet(ActionValue)	idigscan->ZiggoNetworkDataSet(ActionValue)
#define idigscan_ClearPersistent()	idigscan->ClearPersistent()
