#ifndef  _CHSVDVBSRUSSIA_MSORT_PRIV_H
#define  _CHSVDVBSRUSSIA_MSORT_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsRussia_mSort_Priv::
#include "locals_mSort.h"

class CHsvDvbsRussia_mSort_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsRussia_mSort_Priv();
...
//Provided interfaces
private:
IHsvSortingImpl(CHsvDvbsRussia_mSort_Priv,irussiasort);
IHsvPowerImpl(CHsvDvbsRussia_mSort_Priv,isortpow);
public:
...
private:
Pumpdefines(CHsvDvbsRussia_mSort_Priv);

public:
CHsvDvbsRussia_mSort_Priv():i__irussiasort(this),i__isortpow(this)
{
irussiasort	=	&i__irussiasort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsRussia_mSort_Priv::func,replace,(char *)name,this)
