 ...
 */
/*!
 *     \file          hsvcanaldigital_mInstall.c
 *
 *     \brief         -
 *
 */
...
#include "_hsvcanaldigital_mInstall.h"

TRACESYMBOL(m, "dvb/installation/hsvcanaldigital_mInstall")
...
InstStatus CHsvCanalDigitalInstallation_mInstall_Priv::s__mInstStatus;




Pump CHsvCanalDigitalInstallation_mInstall_Priv::s__mInstallPump;


ModuleLifeCycle CHsvCanalDigitalInstallation_mInstall_Priv::s__mModuleLifeCycle = TurnedOff;


t_CanalDigitalCableDSDesc CHsvCanalDigitalInstallation_mInstall_Priv::s__mCableDSDesc;

Nat16 CHsvCanalDigitalInstallation_mInstall_Priv::s__mBarkerMuxONID = 0xFFFF,CHsvCanalDigitalInstallation_mInstall_Priv::s__mBarkerMuxTSID = 0xFFFF;



int CHsvCanalDigitalInstallation_mInstall_Priv::s__mConstellation[14] =
{
...
const FunctionVoid CHsvCanalDigitalInstallation_mInstall_Priv::EventActionMatrix[][StMax] =
{
...
void CHsvCanalDigitalInstallation_mInstall_Priv::PumpHandler(int event, Nat32 param)
{
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::FuncStartInstallation(void)
{
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::FuncStopInstallation(void)
{
    mInitialise();
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::FuncSdmStopped(void)
{
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::FuncStationFound(void)
{
    /* start signal strength measurement */
    sigstr_StartSigStrMeasAll();
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::FuncStationNotFound(void)
{
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::FuncDataAvailable(void)
{
    Bool Proceed = TRUE;
    ...
    if(mInstStatus.TargeNITFound == TRUE)
    {
        ...
        dvbset_SetPreferred(rins_AttributeNetworkFreq, Frequency, TRUE);
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::FuncDataNotAvailable(void)
{
    TraceDebug(m,"%s %d mInstStatus.TargeNITFound %d", __FUNCTION__, __LINE__, mInstStatus.TargeNITFound);
    if(mInstStatus.TargeNITFound == FALSE)
    {
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::mSetTunerAttributes(void)
{
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::mStopSdm(HsvDemux dmx)
{
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::mSelectDecoder(void)
{
}

inline Bool CHsvCanalDigitalInstallation_mInstall_Priv::mAcquireValidNit(void)
{
    int hsvspid = 0;
    Bool retval = FALSE;
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::mInitialise(void)
{
    Nat32 errorcode = 0;
...
void CHsvCanalDigitalInstallation_mInstall_Priv::iinspow_Init(void)
{
    mInstallPump = pmp_PmpCreateEx(pen_PumpEngine, PumpHandler, FALSE,"hsvcanaldigital_mInstall");
    mModuleLifeCycle = Initialised;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinspow_TurnOn(void)
{
    mModuleLifeCycle = TurnedOn;
    mInitialise();
}

FResult CHsvCanalDigitalInstallation_mInstall_Priv::iins_StartInstallation(int source, int ptc, int mode)
{
...
FResult CHsvCanalDigitalInstallation_mInstall_Priv::iins_StopInstallation(void)
{
...
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_ZiggoGetPTCInfo(HsvInstallationPTC *ptc, Nat16 Onid, Nat16 Tsid)
{
    mGetPTCInfo(ptc, Onid, Tsid);
}

int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetTargetNitType(Nat16* NetworkId)
{
...
Bool CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetAltTSValues( Nat16* ONID, Nat16* TSID )
{
    UNUSED(ONID);
    UNUSED(TSID);
    return TRUE;
...
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetSIDetails(HsvSDMSIDataValues* sivalues)
{
	return;
}


int CHsvCanalDigitalInstallation_mInstall_Priv::iins_ZiggoGetSDTType(Nat16 Frequency)
{
    return mGetSDTType(Frequency);
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnStationFound()
{
    TraceDebug(m,"%s %d", __FUNCTION__, __LINE__);
    if(TURNED_ON)
    {
...
void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnStationNotFound()
{
    TraceDebug(m,"%s %d", __FUNCTION__, __LINE__);
    if(TURNED_ON)
    {       
...
void CHsvCanalDigitalInstallation_mInstall_Priv::iinsctrlN_OnEvent( HsvDemux dmx, int eventid, int value )
{
    if(TURNED_ON)
    {
...
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetEpgBarkerMux(Nat16 *ONID, Nat16 *TSID)
{
    mGetEpgBarkerMux(ONID, TSID);
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iins_Initialise()
{ }
FResult CHsvCanalDigitalInstallation_mInstall_Priv::iins_StartDigitalScan(void)
{ return 0; }
FResult CHsvCanalDigitalInstallation_mInstall_Priv::iins_StartDigitalTuning(int frequency)
{   UNUSED(frequency); return 0; }
FResult CHsvCanalDigitalInstallation_mInstall_Priv::iins_StopDigitalScan (void)
{ return 0; }
int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetNoOfPass(void)
{ return 0; }
int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetCurrentPass ( void )
{ return 0; }
FResult CHsvCanalDigitalInstallation_mInstall_Priv::iins_StoreWeakSignalInstallationChannel()
{ return 0; }
int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetNumberOfDigitalChannelsFound()
{ return 0; }
int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetNumberOfDigitalChannelsRemoved()
{ return 0; }
int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetCurrentState()
{ return 0; }
Bool CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetCurTSValues( Nat16* ONID, Nat16* TSID )
{ UNUSED(ONID); UNUSED(TSID); return 0; }
HsvStreamPriority CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetStreamPriority(void)
{ return (HsvStreamPriority)0; }
HsvHierarchyMode CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetHierarchyMode(void)
{ return (HsvHierarchyMode)0; }
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_SetStreamPriority (HsvStreamPriority prio)
{ UNUSED(prio); }
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_SyncComplete(void)
{ }
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_ClearCache(void)
{ }
int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetPLPIds(int *PLPIds)
{ UNUSED(PLPIds); return 0; }
void CHsvCanalDigitalInstallation_mInstall_Priv::iinspow_TurnOff(void)
{ }
int CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetSDTType()
{ return 0; }
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_GetPTCInfo(HsvInstallationPTC *ptc)
{ UNUSED(ptc); }
Bool CHsvCanalDigitalInstallation_mInstall_Priv::iins_ZiggoNetworkDataSet(Bool ActionValue)
{
    UNUSED(ActionValue);
    return FALSE;
}
void CHsvCanalDigitalInstallation_mInstall_Priv::iins_ClearPersistent()
{
    
}
int CHsvCanalDigitalInstallation_mInstall_Priv::mMapFromHsvToPlfDvbcModulation(int InputModulation)
{
...
inline int CHsvCanalDigitalInstallation_mInstall_Priv::mGetSDTType(Nat16 Frequency)
{
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::mGetPTCInfo(HsvInstallationPTC *ptc, Nat16 Onid, Nat16 Tsid)
{
    int i = 0;
...
inline Bool CHsvCanalDigitalInstallation_mInstall_Priv::mLoadCDSDFromStrapi(int hsvspid)
{
    int i, j;
...
inline Bool CHsvCanalDigitalInstallation_mInstall_Priv::mGetAltTSValues(Nat16* ONID, Nat16* TSID)
{
    UNUSED(ONID);
    UNUSED(TSID);
    return TRUE;
...
inline void CHsvCanalDigitalInstallation_mInstall_Priv::mGetEpgBarkerMux(Nat16 *ONID, Nat16 *TSID)
{
...
void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnSearchStateChanged( tmFe_SearchState_t state ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnSearchInProgress( tmFe_SearchState_t state ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnTvSystemDetected( tmFe_TvSystem_t tvSystem ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnAfcFreqChanged( Nat32 freq ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnAfcLimitReached(Nat32 freq ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnAfcModeChanged( void ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnMeasReady( int ssm, Nat32 strength ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnMeasAborted( int ssm ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnConstellationDetected( tmFe_Constellation_t constellation ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnIqModeDetected( tmFe_IqMode_t mode ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnCodeRateDetected( tmFe_CodeRate_t highPrioRate, tmFe_CodeRate_t lowPrioRate ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnHierarchyModeDetected( tmFe_HierarchyMode_t mode ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnGuardIntervalDetected( tmFe_GuardInterval_t interval ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnTxModeDetected( tmFe_TxMode_t mode ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnChanBandwidthDetected( tmFe_ChanBandwidth_t bandwith ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnCarrierPresentChanged( Bool carrier ) 
{
	return;
}

void CHsvCanalDigitalInstallation_mInstall_Priv::iinsfeapiN_OnBerThresholdCrossed( Nat32 ber, Nat32 berThreshold ) 
{
	return;
}
