#ifndef  _CHSVDVBCINSTALLATION_MPRESCAN_PRIV_H
#define  _CHSVDVBCINSTALLATION_MPRESCAN_PRIV_H 
...
#define CLASSSCOPE CHsvDvbCInstallation_mprescan_Priv::
#include "locals_mprescan.h"

class CHsvDvbCInstallation_mprescan_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbCInstallation_mprescan_Priv();
...
//Provided interfaces
private:
IHsvSdmControlNotifyExImpl(CHsvDvbCInstallation_mprescan_Priv,ipctrlN);
IEnableImpl(CHsvDvbCInstallation_mprescan_Priv,ipena);
IHsvDigitalScanImpl(CHsvDvbCInstallation_mprescan_Priv,iprescan);
IHsvFrontEndApiNotifyImpl(CHsvDvbCInstallation_mprescan_Priv,iprescanfeN);
IHsvPowerImpl(CHsvDvbCInstallation_mprescan_Priv,iprescanpow);
public:
...
private:
Pumpdefines(CHsvDvbCInstallation_mprescan_Priv);

public:
CHsvDvbCInstallation_mprescan_Priv():i__ipctrlN(this),i__ipena(this),i__iprescan(this),i__iprescanfeN(this),i__iprescanpow(this)
{
ipctrlN	=	&i__ipctrlN;
ipena	=	&i__ipena;
iprescan	=	&i__iprescan;
iprescanfeN	=	&i__iprescanfeN;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbCInstallation_mprescan_Priv::func,replace,(char *)name,this)
