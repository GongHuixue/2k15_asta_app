#ifndef  _CHsvEuropeInstallation_mblizoosort_Priv_H
#define  _CHsvEuropeInstallation_mblizoosort_Priv_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mblizoosort_Priv::
#include "locals_mblizoosort.h"

class CHsvEuropeInstallation_mblizoosort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mblizoosort_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvEuropeInstallation_mblizoosort_Priv,iblizoopow);
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mblizoosort_Priv,iblizoosort);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mblizoosort_Priv);

public:
CHsvEuropeInstallation_mblizoosort_Priv():i__iblizoopow(this),i__iblizoosort(this)
{
iblizoopow	=	&i__iblizoopow;
iblizoosort	=	&i__iblizoosort;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mblizoosort_Priv::func,replace,(char *)name,this)
