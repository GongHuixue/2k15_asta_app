#ifndef IHSVACIINSTALLATIONSUB_H
#define IHSVACIINSTALLATIONSUB_H
#include <intfparam.h>
#include <provreq.h>
class IHsvAciInstallationSub
{
public:
	virtual ~IHsvAciInstallationSub(){}
...
#define IHsvAciInstallationSubImpl(Comp,intf)    \
...
class Comp ## _ ## intf : public IHsvAciInstallationSub \
{\
private:\
    Comp *m_parent; \
public: \
