#ifndef  _CHSVDVBCINSTALLATION_MDATAACQ_PRIV_H
#define  _CHSVDVBCINSTALLATION_MDATAACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbCInstallation_mDataAcq_Priv::
#include "locals_mDataAcq.h"

class CHsvDvbCInstallation_mDataAcq_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbCInstallation_mDataAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbCInstallation_mDataAcq_Priv,iacqpow);
IHsvStreamNotifyImpl(CHsvDvbCInstallation_mDataAcq_Priv,iacqstrapiN);
IHsvDigitalAcquisitionImpl(CHsvDvbCInstallation_mDataAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbCInstallation_mDataAcq_Priv);

public:
CHsvDvbCInstallation_mDataAcq_Priv():i__iacqpow(this),i__iacqstrapiN(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
iacqstrapiN	=	&i__iacqstrapiN;
...
#define mpldiv_iPresent() (mpldiv.Present())
#define mpldiv_AvSignalDetectionTimeOut	mpldiv->AvSignalDetectionTimeOut()
#define mpldiv_HearingImpairedOn	mpldiv->HearingImpairedOn()
#define mpldiv_VisuallyImpairedOn	mpldiv->VisuallyImpairedOn()
#define mpldiv_SubtitleOn	mpldiv->SubtitleOn()
#define mpldiv_PidCachingEnabled	mpldiv->PidCachingEnabled()
#define mpldiv_SubtitlePidFallbackFirstPMT()	mpldiv->SubtitlePidFallbackFirstPMT()
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbCInstallation_mDataAcq_Priv::func,replace,(char *)name,this)
