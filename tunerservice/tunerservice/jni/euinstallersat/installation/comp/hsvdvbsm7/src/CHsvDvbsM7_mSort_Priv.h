#ifndef  _CHSVDVBSM7_MSORT_PRIV_H
#define  _CHSVDVBSM7_MSORT_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsM7_mSort_Priv::
#include "locals_mSort.h"

class CHsvDvbsM7_mSort_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsM7_mSort_Priv();
...
//Provided interfaces
private:
IHsvSortingImpl(CHsvDvbsM7_mSort_Priv,im7sort);
IHsvPowerImpl(CHsvDvbsM7_mSort_Priv,isortpow);
public:
...
private:
Pumpdefines(CHsvDvbsM7_mSort_Priv);

public:
CHsvDvbsM7_mSort_Priv():i__im7sort(this),i__isortpow(this)
{
im7sort	=	&i__im7sort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsM7_mSort_Priv::func,replace,(char *)name,this)
