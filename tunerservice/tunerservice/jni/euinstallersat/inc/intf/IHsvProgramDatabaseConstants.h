...
public:
	...
	#define IHsvProgramDatabaseConstants_HomingService		((int)0x00001000 )
	#define IHsvProgramDatabaseConstants_CurrentHomingService		((int)0x00002000 )
	#define IHsvProgramDatabaseConstants_InteractiveService		((int)0x00004000 )
	#define IHsvProgramDatabaseConstants_CurrentInteractiveService		((int)0x00008000 )
};
