#ifndef  _CHSVDVBTINSTALLATION_MDATAACQ_PRIV_H
#define  _CHSVDVBTINSTALLATION_MDATAACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbTInstallation_mDataAcq_Priv::
#include "locals_mDataAcq.h"

class CHsvDvbTInstallation_mDataAcq_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbTInstallation_mDataAcq_Priv();
...
//Provided interfaces
private:
IHsvDigitalScanNotifyImpl(CHsvDvbTInstallation_mDataAcq_Priv,digscanN);
IHsvDigitalAcquisitionImpl(CHsvDvbTInstallation_mDataAcq_Priv,idataacq);
IHsvPowerImpl(CHsvDvbTInstallation_mDataAcq_Priv,idatapow);
IHsvSdmControlNotifyImpl(CHsvDvbTInstallation_mDataAcq_Priv,idvbtqctrlN);
public:
...
private:
Pumpdefines(CHsvDvbTInstallation_mDataAcq_Priv);

public:
CHsvDvbTInstallation_mDataAcq_Priv():i__digscanN(this),i__idataacq(this),i__idatapow(this),i__idvbtqctrlN(this)
{
digscanN	=	&i__digscanN;
idataacq	=	&i__idataacq;
idatapow	=	&i__idatapow;
idvbtqctrlN	=	&i__idvbtqctrlN;
module__init();
params__init();
}
...
#define idvbt_iPresent() (idvbt.Present())
...
#define idvbt_Initialise()	idvbt->Initialise()
#define idvbt_StartInstallation(source,ptc,mode)	idvbt->StartInstallation(source,ptc,mode)
#define idvbt_StopInstallation()	idvbt->StopInstallation()
#define idvbt_StartDigitalScan()	idvbt->StartDigitalScan()
#define idvbt_StartDigitalTuning(frequency)	idvbt->StartDigitalTuning(frequency)
#define idvbt_StopDigitalScan()	idvbt->StopDigitalScan()
#define idvbt_GetNoOfPass()	idvbt->GetNoOfPass()
#define idvbt_GetCurrentPass()	idvbt->GetCurrentPass()
#define idvbt_GetPTCInfo(ptc)	idvbt->GetPTCInfo(ptc)
#define idvbt_StoreWeakSignalInstallationChannel()	idvbt->StoreWeakSignalInstallationChannel()
#define idvbt_GetNumberOfDigitalChannelsFound()	idvbt->GetNumberOfDigitalChannelsFound()
#define idvbt_GetNumberOfDigitalChannelsRemoved()	idvbt->GetNumberOfDigitalChannelsRemoved()
#define idvbt_GetTargetNitType(NetworkId)	idvbt->GetTargetNitType(NetworkId)
#define idvbt_GetCurrentState()	idvbt->GetCurrentState()
#define idvbt_GetSDTType()	idvbt->GetSDTType()
#define idvbt_GetAltTSValues(ONID,TSID)	idvbt->GetAltTSValues(ONID,TSID)
#define idvbt_GetCurTSValues(ONID,TSID)	idvbt->GetCurTSValues(ONID,TSID)
#define idvbt_GetStreamPriority()	idvbt->GetStreamPriority()
#define idvbt_SetStreamPriority(prio)	idvbt->SetStreamPriority(prio)
#define idvbt_SyncComplete()	idvbt->SyncComplete()
#define idvbt_ClearCache()	idvbt->ClearCache()
#define idvbt_GetPLPIds(PLPIds)	idvbt->GetPLPIds(PLPIds)
#define idvbt_GetHierarchyMode()	idvbt->GetHierarchyMode()
#define idvbt_ZiggoGetPTCInfo(ptc,Onid,Tsid)	idvbt->ZiggoGetPTCInfo(ptc,Onid,Tsid)
#define idvbt_ZiggoGetSDTType(Frequency)	idvbt->ZiggoGetSDTType(Frequency)
#define idvbt_GetEpgBarkerMux(ONID,TSID)	idvbt->GetEpgBarkerMux(ONID,TSID)
#define idvbt_ZiggoNetworkDataSet(ActionValue)	idvbt->ZiggoNetworkDataSet(ActionValue)
#define idvbt_ClearPersistent()	idvbt->ClearPersistent()
#define idvbt_GetNumberOfChannelListIds()	idvbt->GetNumberOfChannelListIds()
#define idvbt_GetChannelListIdByIndex(index)	idvbt->GetChannelListIdByIndex(index)
#define idvbt_GetNumberOfDigitalChannelsFound()	idvbt->GetNumberOfDigitalChannelsFound()
#define idvbt_SetFavouriteChannelListId(mode,attrib,index)	idvbt->SetFavouriteChannelListId(mode,attrib,index)
#define idvbt_GetChannelListIDName(index,ChannelistName)	idvbt->GetChannelListIDName(index,ChannelistName)
...
#define langids_iPresent() (langids.Present())
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbTInstallation_mDataAcq_Priv::func,replace,(char *)name,this)
