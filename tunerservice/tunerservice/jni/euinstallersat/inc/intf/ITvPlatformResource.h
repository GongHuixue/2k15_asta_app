...
public:
	...
	virtual Nat32 ConvertStateToResourceid(int State)= 0;
	virtual void RequestResource(Nat32 resid)= 0;
...
virtual Nat32 intf ## _ConvertStateToResourceid(int State);\
virtual void intf ## _RequestResource(Nat32 resid);\
...
virtual Nat32 ConvertStateToResourceid(int State){ return m_parent->intf ## _ConvertStateToResourceid(State);}\
virtual void RequestResource(Nat32 resid){ return m_parent->intf ## _RequestResource(resid);}\
};\
