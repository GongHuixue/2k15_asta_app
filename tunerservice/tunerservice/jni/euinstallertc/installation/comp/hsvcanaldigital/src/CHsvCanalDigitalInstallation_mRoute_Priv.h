#ifndef  _CHSVCANALDIGITALINSTALLATION_MROUTE_PRIV_H
#define  _CHSVCANALDIGITALINSTALLATION_MROUTE_PRIV_H 
...
#define CLASSSCOPE CHsvCanalDigitalInstallation_mRoute_Priv::
#include "locals_mRoute.h"

class CHsvCanalDigitalInstallation_mRoute_Priv : public CTCMwBase
{
public:
virtual ~CHsvCanalDigitalInstallation_mRoute_Priv();
...
//Provided interfaces
private:
IHsvSdmControlNotifyExImpl(CHsvCanalDigitalInstallation_mRoute_Priv,ctrlN);
IHsvFrontEndApiNotifyImpl(CHsvCanalDigitalInstallation_mRoute_Priv,feapiN);
IHsvDigitalScanImpl(CHsvCanalDigitalInstallation_mRoute_Priv,ins);
IHsvDigitalScanImpl(CHsvCanalDigitalInstallation_mRoute_Priv,istub);
IHsvPowerImpl(CHsvCanalDigitalInstallation_mRoute_Priv,pow);
public:
...
public:
CHsvCanalDigitalInstallation_mRoute_Priv():i__ctrlN(this),i__feapiN(this),i__ins(this),i__istub(this),i__pow(this)
{
ctrlN	=	&i__ctrlN;
feapiN	=	&i__feapiN;
ins	=	&i__ins;
...
#define idtr_CanalDigitalNetworkDataSet(ActionValue)	idtr->CanalDigitalNetworkDataSet(ActionValue)
