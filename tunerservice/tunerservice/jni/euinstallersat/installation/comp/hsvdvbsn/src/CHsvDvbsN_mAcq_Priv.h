#ifndef  _CHSVDVBSN_MACQ_PRIV_H
#define  _CHSVDVBSN_MACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsN_mAcq_Priv::
#include "locals_mAcq.h"

class CHsvDvbsN_mAcq_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsN_mAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbsN_mAcq_Priv,iacqpow);
IHsvDigitalAcquisitionImpl(CHsvDvbsN_mAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbsN_mAcq_Priv);

public:
CHsvDvbsN_mAcq_Priv():i__iacqpow(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsN_mAcq_Priv::func,replace,(char *)name,this)
