...
#define TV_START_HONRD_OFFSET 		( 0 )
#define TV_MAX_HONRD_OFFSET 		(999)
#define TV_START_NONHONRD_OFFSET 	(1000)
#define TV_MAX_NONHONRD_OFFSET 		(1999)
#define RADIO_START_HONRD_OFFSET 	(2000)
#define RADIO_MAX_HONRD_OFFSET 		(2999)
#define RADIO_START_NONHONRD_OFFSET (3000)
#define RADIO_MAX_NONHONRD_OFFSET 	(3999)
#define ADD_ENTRY               	( 0 )
#define UPDATE_ENTRY            	( 1 )
#define MAX_PRESET_NUMBER			(4000)
