...
//TRACESYMBOL(m, "dvb/sitables/hsvdvbsi_m")
...
Bool CHsvDvbSiDataManager_m_Priv::strmfltr_Set(HsvDestination dest, int filterid, int value)
{
    ...
    switch(filterid)
    {
        ...
        case HsvShortDescSerId :    
            retval = chsvdvbeit_strmfltr_Set( dest, filterid, value );
            break;
...
Bool CHsvDvbSiDataManager_m_Priv::strmfltr_Clear(HsvDestination dest, int filterid, int value)
{
    ...
    switch(filterid)
    {
        ...
        case HsvShortDescTsId :
        case HsvShortDescSerId :            
            retval = chsvdvbeit_strmfltr_Clear( dest, filterid, value );
            break;
        case HsvOtherSDTOnwidId: 
        case HsvOtherSDTServiceId:            
            break; 
...
Bool CHsvDvbSiDataManager_m_Priv::strmfltr_ForceClear(HsvDestination dest, int filterid, int value)
{    
	Bool retval = FALSE;
	switch (filterid)   
	{ 
		case HsvOtherSDTServiceId:        
		{ 
			retval = chsvdvbsdt_strmfltr_ForceClear( dest, filterid, value );   
		} 
		break;
		default:
		retval = FALSE;    
...
Bool CHsvDvbSiDataManager_m_Priv::strmfltr_IsReady(HsvDestination dest,int filterid)
{
	return FALSE;
}
...
void CHsvDvbSiDataManager_m_Priv::dmxsecfN_OnRequestNotAllowed(void)
{
}
