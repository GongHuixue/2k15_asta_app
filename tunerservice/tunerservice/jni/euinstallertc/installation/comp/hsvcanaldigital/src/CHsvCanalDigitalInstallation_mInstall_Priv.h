#ifndef  _CHSVCANALDIGITALINSTALLATION_MINSTALL_PRIV_H
#define  _CHSVCANALDIGITALINSTALLATION_MINSTALL_PRIV_H 
...
#define CLASSSCOPE CHsvCanalDigitalInstallation_mInstall_Priv::
#include "locals_mInstall.h"

class CHsvCanalDigitalInstallation_mInstall_Priv : public CTCMwBase
{
public:
virtual ~CHsvCanalDigitalInstallation_mInstall_Priv();
...
//Provided interfaces
private:
IHsvDigitalScanImpl(CHsvCanalDigitalInstallation_mInstall_Priv,iins);
IHsvSdmControlNotifyExImpl(CHsvCanalDigitalInstallation_mInstall_Priv,iinsctrlN);
IHsvFrontEndApiNotifyImpl(CHsvCanalDigitalInstallation_mInstall_Priv,iinsfeapiN);
IHsvPowerImpl(CHsvCanalDigitalInstallation_mInstall_Priv,iinspow);
public:
...
private:
Pumpdefines(CHsvCanalDigitalInstallation_mInstall_Priv);

public:
CHsvCanalDigitalInstallation_mInstall_Priv():i__iins(this),i__iinsctrlN(this),i__iinsfeapiN(this),i__iinspow(this)
{
iins	=	&i__iins;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvCanalDigitalInstallation_mInstall_Priv::func,replace,(char *)name,this)
