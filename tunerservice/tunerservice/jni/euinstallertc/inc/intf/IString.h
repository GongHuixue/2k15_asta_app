...
public:
	...
	virtual int strlen(char * str1)= 0;
	virtual int strlenRom(char ROM * str1)= 0;
...
virtual int intf ## _strlen(char * str1);\
virtual int intf ## _strlenRom(char ROM * str1);\
...
virtual int strlen(char * str1){ return m_parent->intf ## _strlen(str1);}\
virtual int strlenRom(char ROM * str1){ return m_parent->intf ## _strlenRom(str1);}\
