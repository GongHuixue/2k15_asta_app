#ifndef  _CHSVPRESETINSTALLATION_MACI_PRIV_H
#define  _CHSVPRESETINSTALLATION_MACI_PRIV_H 
...
#define CLASSSCOPE CHsvPresetInstallation_maci_Priv::
#include "locals_maci.h"

class CHsvPresetInstallation_maci_Priv : public CTCMwBase
{
public:
virtual ~CHsvPresetInstallation_maci_Priv();
...
//Provided interfaces
private:
IHsvAciDataImpl(CHsvPresetInstallation_maci_Priv,acidat);
public:
...
public:
CHsvPresetInstallation_maci_Priv():i__acidat(this)
{
acidat	=	&i__acidat;
module__init();
params__init();
...
#define lngids_MaxNumberOfLanguages	lngids->MaxNumberOfLanguages()
