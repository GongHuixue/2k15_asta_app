#ifndef IHSVPROGRAMDATACONTROLNOTIFY3_H
#define IHSVPROGRAMDATACONTROLNOTIFY3_H
#include <intfparam.h>
#include <provreq.h>
class IHsvProgramDataControlNotify3
{
public:
	virtual ~IHsvProgramDataControlNotify3(){}
	#define IHsvProgramDataControlNotify3_SelectedMediumChanged		((int)0 )
	#define IHsvProgramDataControlNotify3_InstalledMediumChanged		((int)1 )
...
#define IHsvProgramDataControlNotify3Impl(Comp,intf)    \
...
class Comp ## _ ## intf : public IHsvProgramDataControlNotify3 \
{\
private:\
    Comp *m_parent; \
public: \
