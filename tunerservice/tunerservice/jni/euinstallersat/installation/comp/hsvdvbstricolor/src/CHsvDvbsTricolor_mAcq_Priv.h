#ifndef  _CHSVDVBSTRICOLOR_MACQ_PRIV_H
#define  _CHSVDVBSTRICOLOR_MACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsTricolor_mAcq_Priv::
#include "locals_mAcq.h"

class CHsvDvbsTricolor_mAcq_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsTricolor_mAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbsTricolor_mAcq_Priv,iacqpow);
IHsvDigitalAcquisitionImpl(CHsvDvbsTricolor_mAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbsTricolor_mAcq_Priv);

public:
CHsvDvbsTricolor_mAcq_Priv():i__iacqpow(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsTricolor_mAcq_Priv::func,replace,(char *)name,this)
