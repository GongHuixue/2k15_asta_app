#ifndef  _CHSVEUROPEINSTALLATION_MITASORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MITASORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mitasort_Priv::
#include "locals_mitasort.h"

class CHsvEuropeInstallation_mitasort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mitasort_Priv();
...
//Provided interfaces
private:
IHsvConflictsNotifyImpl(CHsvEuropeInstallation_mitasort_Priv,iconfN);
IHsvPowerImpl(CHsvEuropeInstallation_mitasort_Priv,iitapow);
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mitasort_Priv,itasort);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mitasort_Priv);

public:
CHsvEuropeInstallation_mitasort_Priv():i__iconfN(this),i__iitapow(this),i__itasort(this)
{
iconfN	=	&i__iconfN;
iitapow	=	&i__iitapow;
itasort	=	&i__itasort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mitasort_Priv::func,replace,(char *)name,this)
...
#define iconfN_ConflictsResolved	IHsvConflictsNotify_ConflictsResolved
#define iconfN_ConflictsNotResolved	IHsvConflictsNotify_ConflictsNotResolved
