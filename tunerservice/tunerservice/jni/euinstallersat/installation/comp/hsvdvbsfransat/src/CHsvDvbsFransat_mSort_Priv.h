#ifndef  _CHSVDVBSFRANSAT_MSORT_PRIV_H
#define  _CHSVDVBSFRANSAT_MSORT_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsFransat_mSort_Priv::
#include "locals_mSort.h"

class CHsvDvbsFransat_mSort_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsFransat_mSort_Priv();
...
//Provided interfaces
private:
IHsvSortingImpl(CHsvDvbsFransat_mSort_Priv,ifransatsort);
IHsvPowerImpl(CHsvDvbsFransat_mSort_Priv,isortpow);
public:
...
private:
Pumpdefines(CHsvDvbsFransat_mSort_Priv);

public:
CHsvDvbsFransat_mSort_Priv():i__ifransatsort(this),i__isortpow(this)
{
ifransatsort	=	&i__ifransatsort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsFransat_mSort_Priv::func,replace,(char *)name,this)
