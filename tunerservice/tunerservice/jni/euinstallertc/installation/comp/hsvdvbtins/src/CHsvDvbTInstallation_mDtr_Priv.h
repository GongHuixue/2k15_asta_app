#ifndef  _CHSVDVBTINSTALLATION_MDTR_PRIV_H
#define  _CHSVDVBTINSTALLATION_MDTR_PRIV_H 
...
#define CLASSSCOPE CHsvDvbTInstallation_mDtr_Priv::
#include "locals_mDtr.h"

class CHsvDvbTInstallation_mDtr_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbTInstallation_mDtr_Priv();
...
//Provided interfaces
private:
IHsvSdmControlNotifyExImpl(CHsvDvbTInstallation_mDtr_Priv,idctrlN);
IHsvDigitalScanImpl(CHsvDvbTInstallation_mDtr_Priv,idtr);
IHsvFrontEndApiNotifyImpl(CHsvDvbTInstallation_mDtr_Priv,idtrfeN);
IHsvPowerImpl(CHsvDvbTInstallation_mDtr_Priv,idtrpow);
IHsvStreamNotifyImpl(CHsvDvbTInstallation_mDtr_Priv, idstrapiN);
public:
...
private:
Pumpdefines(CHsvDvbTInstallation_mDtr_Priv);

public:
CHsvDvbTInstallation_mDtr_Priv():i__idctrlN(this),i__idtr(this),i__idtrfeN(this),i__idtrpow(this),i__idstrapiN(this)
{
idctrlN	=	&i__idctrlN;
idtr	=	&i__idtr;
idtrfeN	=	&i__idtrfeN;
idtrpow	=	&i__idtrpow;
idstrapiN	=	&i__idstrapiN;
module__init();
params__init();
}
...
#define insN_EventT2SwitchPLPID IHsvInstallationNotify_EventT2SwitchPLPID
...
#define insN_EventServiceNotFound IHsvInstallationNotify_EventServiceNotFound
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbTInstallation_mDtr_Priv::func,replace,(char *)name,this)
...
#define sysset_GetIsDVBT2Scan() sysset->GetIsDVBT2Scan()
#define sysset_GetFocusedPlpId() sysset->GetFocusedPlpId()
...
#define sysset_SetUpdatedONID(Onid) sysset->SetUpdatedONID(Onid)
#define sysset_SetUpdatedTsID(Tsid) sysset->SetUpdatedTsID(Tsid)
