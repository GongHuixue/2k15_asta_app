#ifndef  _CHSVDVBSCANAL_MACQ_PRIV_H
#define  _CHSVDVBSCANAL_MACQ_PRIV_H 
...
#include <CS2MwBase.h>
class CHsvDvbsCanal_mAcq_Priv;
#define CLASSSCOPE CHsvDvbsCanal_mAcq_Priv::
#include "locals_mAcq.h"

class CHsvDvbsCanal_mAcq_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsCanal_mAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbsCanal_mAcq_Priv,iacqpow);
IHsvDigitalAcquisitionImpl(CHsvDvbsCanal_mAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbsCanal_mAcq_Priv);

public:
CHsvDvbsCanal_mAcq_Priv():i__iacqpow(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsCanal_mAcq_Priv::func,replace,(char *)name,this)
