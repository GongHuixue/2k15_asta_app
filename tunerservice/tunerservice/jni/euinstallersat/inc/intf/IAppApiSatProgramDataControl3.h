#ifndef IAPPAPISATPROGRAMDATACONTROL3_H
#define IAPPAPISATPROGRAMDATACONTROL3_H
#include <intfparam.h>
#include <provreq.h>
class IAppApiSatProgramDataControl3
{
public:
	virtual ~IAppApiSatProgramDataControl3(){}
	...
	#define IAppApiSatProgramDataControl3_SelectionTypeNormal		((int)0 )
	#define IAppApiSatProgramDataControl3_SelectionTypeQuite		((int)1 )
	#define IAppApiSatProgramDataControl3_SelectionTypeNonDestructive		((int)2 )
	#define IAppApiSatProgramDataControl3_SelectionTypeQuiteNonDestructive		((int)3 )
	...
	#define IAppApiSatProgramDataControl3_CcOn		((int)0 )
	#define IAppApiSatProgramDataControl3_CcOff		((int)1 )
	#define IAppApiSatProgramDataControl3_CcOnDuringMute		((int)2 )
	#define IAppApiSatProgramDataControl3_SubtitleOff		((int)0 )
	#define IAppApiSatProgramDataControl3_SubtitleOn		((int)1 )
	#define IAppApiSatProgramDataControl3_SubtitleOnDuringMute		((int)2 )
	#define IAppApiSatProgramDataControl3_AntennaMap		((int)0 )
	#define IAppApiSatProgramDataControl3_CableMap		((int)1 )
};


#define IAppApiSatProgramDataControl3Impl(Comp,intf)    \
...
class Comp ## _ ## intf : public IAppApiSatProgramDataControl3 \
{\
private:\
    Comp *m_parent; \
public: \
