#ifndef  _CHSVDVBSINSTALLATION_MSATIPPRESCAN_PRIV_H
#define  _CHSVDVBSINSTALLATION_MSATIPPRESCAN_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsInstallation_msatipprescan_Priv::
#include "locals_msatipprescan.h"

class CHsvDvbsInstallation_msatipprescan_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsInstallation_msatipprescan_Priv();
...
//Provided interfaces
private:
IHsvSatelliteInstallationImpl(CHsvDvbsInstallation_msatipprescan_Priv,iprescan);
IHsvSdmControlNotifyExImpl(CHsvDvbsInstallation_msatipprescan_Priv,iprescanctrlN);
IHsvDigitalScanDataImpl(CHsvDvbsInstallation_msatipprescan_Priv,iprescandata);
IHsvPowerImpl(CHsvDvbsInstallation_msatipprescan_Priv,iprescanpow);
IHsvSatelliteFrontEndNotifyImpl(CHsvDvbsInstallation_msatipprescan_Priv,iprescansatfrontendN);
public:
...
private:
Pumpdefines(CHsvDvbsInstallation_msatipprescan_Priv);

public:
CHsvDvbsInstallation_msatipprescan_Priv():i__iprescan(this),i__iprescanctrlN(this),i__iprescandata(this),i__iprescanpow(this),i__iprescansatfrontendN(this)
{
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsInstallation_msatipprescan_Priv::func,replace,(char *)name,this)
