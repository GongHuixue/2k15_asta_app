#ifndef IHSVSATPROGRAMDATACONTROL3EX_H
#define IHSVSATPROGRAMDATACONTROL3EX_H
#include <intfparam.h>
#include <provreq.h>
class IHsvSatProgramDataControl3Ex
{
public:
	virtual ~IHsvSatProgramDataControl3Ex(){}
	#define IHsvSatProgramDataControl3Ex_Terrestrial		((int)0 )
	#define IHsvSatProgramDataControl3Ex_Cable		((int)1 )
	#define IHsvSatProgramDataControl3Ex_Satellite		((int)2 )
	#define IHsvSatProgramDataControl3Ex_CcOn		((int)0 )
	#define IHsvSatProgramDataControl3Ex_CcOff		((int)1 )
	#define IHsvSatProgramDataControl3Ex_CcOnDuringMute		((int)2 )
	#define IHsvSatProgramDataControl3Ex_SubtitleOff		((int)0 )
	#define IHsvSatProgramDataControl3Ex_SubtitleOn		((int)1 )
	#define IHsvSatProgramDataControl3Ex_SubtitleOnDuringMute		((int)2 )
	#define IHsvSatProgramDataControl3Ex_SelectionTypeNormal		((int)0 )
	#define IHsvSatProgramDataControl3Ex_SelectionTypeQuite		((int)1 )
	#define IHsvSatProgramDataControl3Ex_SelectionTypeNonDestructive		((int)2 )
	#define IHsvSatProgramDataControl3Ex_SelectionTypeQuiteNonDestructive		((int)3 )
...
#define IHsvSatProgramDataControl3ExImpl(Comp,intf)    \
...
class Comp ## _ ## intf : public IHsvSatProgramDataControl3Ex \
{\
private:\
    Comp *m_parent; \
public: \
