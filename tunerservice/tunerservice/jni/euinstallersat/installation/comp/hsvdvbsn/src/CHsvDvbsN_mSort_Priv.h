#ifndef  _CHSVDVBSN_MSORT_PRIV_H
#define  _CHSVDVBSN_MSORT_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsN_mSort_Priv::
#include "locals_mSort.h"

class CHsvDvbsN_mSort_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsN_mSort_Priv();
...
//Provided interfaces
private:
IHsvSortingImpl(CHsvDvbsN_mSort_Priv,insort);
IHsvPowerImpl(CHsvDvbsN_mSort_Priv,isortpow);
public:
...
private:
Pumpdefines(CHsvDvbsN_mSort_Priv);

public:
CHsvDvbsN_mSort_Priv():i__insort(this),i__isortpow(this)
{
insort	=	&i__insort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsN_mSort_Priv::func,replace,(char *)name,this)
