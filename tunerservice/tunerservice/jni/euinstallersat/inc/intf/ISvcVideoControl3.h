...
public:
	...
	virtual int VcVga(void)= 0;
	virtual int VcXvga(void)= 0;
	virtual int VcSvga(void)= 0;
	virtual int VcWxvga(void)= 0;
	...
	virtual int VideoMutePogramBlack(void)= 0;
...
public: \
    ...
    InterfaceParam<Comp,int> m_VideoMute; \
    ...
    InterfaceParam<Comp,int> m_VcVga; \
    InterfaceParam<Comp,int> m_VcXvga; \
    InterfaceParam<Comp,int> m_VcSvga; \
    InterfaceParam<Comp,int> m_VcWxvga; \
    ...
    InterfaceParam<Comp,int> m_VideoMutePogramBlack; \
...
virtual int VideoMute(void){ return m_VideoMute.Call();}\
...
virtual int VcVga(void){ return m_VcVga.Call();}\
virtual int VcXvga(void){ return m_VcXvga.Call();}\
virtual int VcSvga(void){ return m_VcSvga.Call();}\
virtual int VcWxvga(void){ return m_VcWxvga.Call();}\
...
virtual int VideoMutePogramBlack(void){ return m_VideoMutePogramBlack.Call();}\
