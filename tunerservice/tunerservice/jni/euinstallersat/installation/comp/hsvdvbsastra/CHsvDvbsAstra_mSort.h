#ifndef  _CHSVDVBSASTRA_MSORT_H
#define  _CHSVDVBSASTRA_MSORT_H 
...
#define ASTRA_NUM_OF_PRIORITY	3


class CHsvDvbsAstra_mSort: private IHsvSorting,IHsvPower,public CS2MwBase
{
public:
ProvidesInterface<IHsvSorting>	iastrasort;
...
private:
Pumpdefines(CHsvDvbsAstra_mSort);
...
int SvcPriority[ASTRA_NUM_OF_PRIORITY];
static int s__SvcPriority[ASTRA_NUM_OF_PRIORITY];
...
private:
/*IHsvSorting*/
virtual void Sort(Nat32 PackageIndex);
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsAstra_mSort::func,replace,(char *)name,this)
