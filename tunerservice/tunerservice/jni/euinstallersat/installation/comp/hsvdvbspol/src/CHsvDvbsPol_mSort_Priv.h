#ifndef  _CHSVDVBSPOL_MSORT_PRIV_H
#define  _CHSVDVBSPOL_MSORT_PRIV_H 
...
#include <CS2MwBase.h>
class CHsvDvbsPol_mSort_Priv;
#define CLASSSCOPE CHsvDvbsPol_mSort_Priv::
#include "locals_mSort.h"

class CHsvDvbsPol_mSort_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsPol_mSort_Priv();
...
//Provided interfaces
private:
IHsvSortingImpl(CHsvDvbsPol_mSort_Priv,ipolsort);
IHsvPowerImpl(CHsvDvbsPol_mSort_Priv,isortpow);
public:
ProvidesInterface<IHsvSorting>	ipolsort;
...
private:
Pumpdefines(CHsvDvbsPol_mSort_Priv);

public:
CHsvDvbsPol_mSort_Priv():i__ipolsort(this),i__isortpow(this)
{
ipolsort	=	&i__ipolsort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsPol_mSort_Priv::func,replace,(char *)name,this)
