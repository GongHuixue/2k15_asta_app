#ifndef IAPPAPISATPROGRAMDATACONTROLNOTIFY2_H
#define IAPPAPISATPROGRAMDATACONTROLNOTIFY2_H
#include <intfparam.h>
#include <provreq.h>
class IAppApiSatProgramDataControlNotify2
{
public:
	virtual ~IAppApiSatProgramDataControlNotify2(){}
...
#define IAppApiSatProgramDataControlNotify2Impl(Comp,intf)    \
...
class Comp ## _ ## intf : public IAppApiSatProgramDataControlNotify2 \
{\
private:\
    Comp *m_parent; \
public: \
