...
public:
	...
	virtual Bool GetByKeyForFreesat(int tableid,Address channeldata)= 0;
	...
	virtual void SelectChannelDatabase (int databaseId) = 0;
	virtual void SyncDatabase (int fromDatabaseId, int toDatabaseId) = 0;
...
virtual Bool intf ## _GetByKeyForFreesat(int tableid,Address channeldata);\
...
virtual void intf ## _SelectChannelDatabase (int databaseId);\
virtual void intf ## _SyncDatabase (int fromDatabaseId, int toDatabaseId);\
...
virtual Bool GetByKeyForFreesat(int tableid,Address channeldata){ return m_parent->intf ## _GetByKeyForFreesat(tableid,channeldata);}\
...
virtual void SelectChannelDatabase(int databaseId) { return m_parent->intf ## _SelectChannelDatabase(databaseId);}\
virtual void SyncDatabase(int fromDatabaseId, int toDatabaseId)  	{ return m_parent->intf ## _SyncDatabase(fromDatabaseId,toDatabaseId);}\
