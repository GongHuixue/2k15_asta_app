#ifndef  _CHSVDVBTINSTALLATION_MQUICK_PRIV_H
#define  _CHSVDVBTINSTALLATION_MQUICK_PRIV_H 
...
#define CLASSSCOPE CHsvDvbTInstallation_mQuick_Priv::
#include "locals_mQuick.h"

class CHsvDvbTInstallation_mQuick_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbTInstallation_mQuick_Priv();
...
//Provided interfaces
private:
IHsvSdmControlNotifyExImpl(CHsvDvbTInstallation_mQuick_Priv,iqctrlN);
IHsvDigitalScanImpl(CHsvDvbTInstallation_mQuick_Priv,iquick);
IHsvFrontEndApiNotifyImpl(CHsvDvbTInstallation_mQuick_Priv,iquickfeN);
IHsvPowerImpl(CHsvDvbTInstallation_mQuick_Priv,iquickpow);
public:
...
private:
Pumpdefines(CHsvDvbTInstallation_mQuick_Priv);

public:
CHsvDvbTInstallation_mQuick_Priv():i__iqctrlN(this),i__iquick(this),i__iquickfeN(this),i__iquickpow(this)
{
iqctrlN	=	&i__iqctrlN;
iquick	=	&i__iquick;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbTInstallation_mQuick_Priv::func,replace,(char *)name,this)
