#ifndef  _CHSVEUROPEINSTALLATION_MSORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MSORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_msort_Priv::
#include "locals_msort.h"

class CHsvEuropeInstallation_msort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_msort_Priv();
...
//Provided interfaces
private:
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_msort_Priv,idvbtsort);
IHsvPowerImpl(CHsvEuropeInstallation_msort_Priv,idvbtsortpow);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_msort_Priv);

public:
CHsvEuropeInstallation_msort_Priv():i__idvbtsort(this),i__idvbtsortpow(this)
{
idvbtsort	=	&i__idvbtsort;
idvbtsortpow	=	&i__idvbtsortpow;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_msort_Priv::func,replace,(char *)name,this)
