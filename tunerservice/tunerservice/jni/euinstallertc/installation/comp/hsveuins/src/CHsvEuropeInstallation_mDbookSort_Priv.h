#ifndef  _CHSVEUROPEINSTALLATION_MDBOOKSORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MDBOOKSORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mDbookSort_Priv::
#include "locals_mDbookSort.h"

class CHsvEuropeInstallation_mDbookSort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mDbookSort_Priv();
...
//Provided interfaces
private:
IHsvConflictsNotifyImpl(CHsvEuropeInstallation_mDbookSort_Priv,idbookconfN);
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mDbookSort_Priv,idbooksort);
IHsvPowerImpl(CHsvEuropeInstallation_mDbookSort_Priv,idbooksortpow);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mDbookSort_Priv);

public:
CHsvEuropeInstallation_mDbookSort_Priv():i__idbookconfN(this),i__idbooksort(this),i__idbooksortpow(this)
{
idbookconfN	=	&i__idbookconfN;
idbooksort	=	&i__idbooksort;
idbooksortpow	=	&i__idbooksortpow;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mDbookSort_Priv::func,replace,(char *)name,this)
