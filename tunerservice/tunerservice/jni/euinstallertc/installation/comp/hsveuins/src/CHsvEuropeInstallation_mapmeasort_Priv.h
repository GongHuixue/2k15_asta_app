#ifndef  _CHSVEUROPEINSTALLATION_MAPMEASORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MAPMEASORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mapmeasort_Priv::
#include "locals_mapmeasort.h"

class CHsvEuropeInstallation_mapmeasort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mapmeasort_Priv();
...
//Provided interfaces
private:
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mapmeasort_Priv,idvbtapmeasort);
IHsvPowerImpl(CHsvEuropeInstallation_mapmeasort_Priv,idvbtapmeasortpow);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mapmeasort_Priv);

public:
CHsvEuropeInstallation_mapmeasort_Priv():i__idvbtapmeasort(this),i__idvbtapmeasortpow(this)
{
idvbtapmeasort	=	&i__idvbtapmeasort;
idvbtapmeasortpow	=	&i__idvbtapmeasortpow;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mapmeasort_Priv::func,replace,(char *)name,this)
