...
SCALAR_ITEM(IntLnbNumber			   ,Nat8   ,NO     ,1      ,LnbNumber			   ,Nat8    ,DIGITAL_ATTRIB)	/*Newly Added */
SCALAR_ITEM(IntPolarization			   ,Nat8   ,NO     ,1      ,Polarization		   ,Nat8    ,DIGITAL_ATTRIB)	/*Newly Added */
...
//SCALAR_ITEM(BoolFavorite			  ,Bool   ,NO     ,1      ,Favorite				  ,Nat8     ,COMMON_ATTRIB)
//SCALAR_ITEM(BoolFavorite1             ,Bool   ,NO     ,1      ,Favorite1              ,Nat8     ,COMMON_ATTRIB)
//SCALAR_ITEM(BoolFavorite2             ,Bool   ,NO     ,1      ,Favorite2              ,Nat8     ,COMMON_ATTRIB)
//SCALAR_ITEM(BoolFavorite3             ,Bool   ,NO     ,1      ,Favorite3              ,Nat8     ,COMMON_ATTRIB)
...
//SCALAR_ITEM(BoolHMProtectedChannel    ,Bool   ,NO     ,1      ,HMProtectedChannel     ,Nat8     ,COMMON_ATTRIB)
//SCALAR_ITEM(BoolHMBlanked             ,Bool   ,NO     ,1      ,HMBlanked              ,Nat8     ,COMMON_ATTRIB)
//SCALAR_ITEM(BoolUserHidden            ,Bool   ,NO     ,1      ,UserHidden             ,Nat8     ,COMMON_ATTRIB)
SCALAR_ITEM(BoolSystemHidden          ,Bool   ,NO     ,1      ,SystemHidden           ,Nat8     ,DIGITAL_ATTRIB)
//SCALAR_ITEM(BoolNumericSelect         ,Bool   ,PTR	     ,1      ,NumericSelect          ,Nat8     ,DIGITAL_ATTRIB)
//SCALAR_ITEM(BoolEpgChannel            ,Bool   ,NO     ,1      ,EPGEnabled             ,Nat8     ,DIGITAL_ATTRIB)
...
//SCALAR_ITEM(BoolChannelVirgin           ,Bool  ,NO     ,1      ,ChannelVirgin         ,Nat8   ,ANALOG_ATTRIB)
SCALAR_ITEM(BoolUpdateName              ,Bool  ,NO     ,1      ,UserModifiedName            ,Nat8   ,COMMON_ATTRIB)
//SCALAR_ITEM(IntDataIndicator            ,int    ,NO     ,1      ,DataIndicator        ,Nat8   ,ANALOG_ATTRIB)
...
//SCALAR_ITEM(IntInstallMode              ,int   ,NO     ,1      ,InstallMode            ,Nat16  ,ANALOG_ATTRIB) 
...
//SCALAR_ITEM(IntHMMapChannelNo           ,int   ,NO     ,1      ,HMMapChannelNo        ,Nat8   ,COMMON_ATTRIB)
SCALAR_ITEM(IntPtc						,int   ,NO     ,0      ,Ptc					  ,Nat32   ,DIGITAL_ATTRIB)     
//SCALAR_ITEM(IntAssociatedDecoder        ,int   ,NO     ,1      ,AssociatedDecoder     ,Nat8   ,ANALOG_ATTRIB)    
//SCALAR_ITEM(Nat32DateStamp             ,Nat32  ,NO     ,1      ,DateStamp             ,Nat32   ,DIGITAL_ATTRIB)
//SCALAR_ITEM(Nat32AppsCookie            ,Nat32  ,NO     ,1      ,AppsCookie             ,Nat32   ,COMMON_ATTRIB)
//SCALAR_ITEM(Nat32TxtCookie             ,Nat32  ,NO     ,1      ,TxtCookie              ,Nat32   ,COMMON_ATTRIB)
//SCALAR_ITEM(Nat32CesvcCookie           ,Nat32  ,NO     ,1      ,CesvcCookie            ,Nat32   ,COMMON_ATTRIB)
...
//SCALAR_ITEM(BoolEPGShortInfoEnabled    ,Bool   ,NO     ,1      ,EPGShortInfo           ,Nat8    ,DIGITAL_ATTRIB)
...
//SCALAR_ITEM(IntNewChannelMap           ,Nat8   ,NO     ,1      ,NewChannelMap          ,Nat8    ,COMMON_ATTRIB)
//VECTOR_ITEM(StringExtChannelName       ,Nat16  ,PTR    ,1      ,ExtChannelName         ,Nat16   ,COMMON_ATTRIB)    
SCALAR_ITEM(IntSystemHidden            ,Nat8   ,NO     ,1      ,SystemHidden           ,Nat8    ,DIGITAL_ATTRIB)
//SCALAR_ITEM(IntNumericSelect           ,Nat8   ,PTR     ,1      ,NumericSelect          ,Nat8    ,DIGITAL_ATTRIB)
SCALAR_ITEM(IntNewChannel              ,Nat8   ,NO     ,1      ,NewChannel             ,Nat8    ,DIGITAL_ATTRIB)
//VECTOR_ITEM(StringSatelliteName        ,Nat16  ,PTR    ,1      ,SatelliteName          ,Nat16   ,DIGITAL_ATTRIB)
SCALAR_ITEM(IntSrcambledStatus         ,Nat8   ,NO     ,1      ,SrcambledStatus        ,Nat8    ,DIGITAL_ATTRIB)
//SCALAR_ITEM(IntInstalledSatelliteNumber,Nat8   ,NO     ,1      ,InstalledSatelliteNumber,Nat8   ,DIGITAL_ATTRIB)
//SCALAR_ITEM(IntUserHidden			   ,Nat8   ,NO     ,1      ,UserHidden			   ,Nat8    ,COMMON_ATTRIB)
SCALAR_ITEM(FavoriteNumber			   ,Nat16  ,NO     ,1     ,FavoriteNumber		   ,Nat16   ,COMMON_ATTRIB)
//SCALAR_ITEM(FavoriteNumber1			   ,Nat8   ,NO     ,1      ,FavoriteNumber1		   ,Nat8    ,COMMON_ATTRIB)
//SCALAR_ITEM(FavoriteNumber2			   ,Nat8   ,NO     ,1      ,FavoriteNumber2		   ,Nat8    ,COMMON_ATTRIB)
//SCALAR_ITEM(FavoriteNumber3			   ,Nat8   ,NO     ,1      ,FavoriteNumber3		   ,Nat8    ,COMMON_ATTRIB)
//SCALAR_ITEM(IntEPGEnabled			   ,Nat8   ,NO     ,1      ,EPGEnabled		       ,Nat8    ,DIGITAL_ATTRIB)
...
//SCALAR_ITEM(Nat32TPID				   ,Nat32  ,NO     ,1      ,TPID				   ,Nat32   ,DIGITAL_ATTRIB)	/*Newly Added */
