#ifndef ISVCCNIDATANOTIFY_H
#define ISVCCNIDATANOTIFY_H
#include <intfparam.h>
#include <provreq.h>
class ISvcCniDataNotify
{
public:
	virtual ~ISvcCniDataNotify(){}
...
#define ISvcCniDataNotifyImpl(Comp,intf)    \
...
friend class InterfaceParam<Comp,int>;\
class Comp ## _ ## intf : public ISvcCniDataNotify \
{\
private:\
    Comp *m_parent; \
public: \
