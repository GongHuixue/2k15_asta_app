#ifndef  _CHSVDVBSINSTALLATION_MPRESCAN_H
#define  _CHSVDVBSINSTALLATION_MPRESCAN_H 
...
class CHsvDvbsInstallation_mprescan
{
public:
...
public:
CHsvDvbsInstallation_mprescan();
virtual ~CHsvDvbsInstallation_mprescan();
private:
CHsvDvbsInstallation_mprescan_Priv	*m_priv;
};
