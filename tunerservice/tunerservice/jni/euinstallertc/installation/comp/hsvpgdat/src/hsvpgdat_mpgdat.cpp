...
int CHsvProgramData_mpgdat_Priv::s__gmqd;
...
pthread_mutex_t CHsvProgramData_mpgdat_Priv::s__pgdatmutex;

int CHsvProgramData_mpgdat_Priv::s__mPgdatExtTaskId = 0;

PgdatLoadSaveMsg CHsvProgramData_mpgdat_Priv::s__mPgdatMsg;


void CHsvProgramData_mpgdat_Priv::ipgdatpow_Init(void)
{
#if 0
...
void CHsvProgramData_mpgdat_Priv::PgdatExternalEventHandler(int param)
{
	Nat32	PgdatExtEvent;
#if 0
	while (1)
...
void CHsvProgramData_mpgdat_Priv::ipgdatpow_TurnOn(void)
{

}
void CHsvProgramData_mpgdat_Priv::ipgdatpow_TurnOff(void)
{

}

void CHsvProgramData_mpgdat_Priv::pgdat_ClearCurrentTable(void)
{
...
void CHsvProgramData_mpgdat_Priv::pgdat_ClearAllTables(void)
{
    ipgdb_ClearTable(ipgdb_GetCurrentTable());
...
Bool CHsvProgramData_mpgdat_Priv::pgdat_IsValidChannel(AppApiChannel channel)
{
    Bool ret = FALSE;
...
Bool CHsvProgramData_mpgdat_Priv::pgdat_IsChannelInstalled(AppApiChannel *channel )
{
    Bool retval = FALSE;
...
Bool CHsvProgramData_mpgdat_Priv::pgdat_IsAttributeSupported(int attribute)
{
    return mIsAttributeSupported(attribute);
}

AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_GetChannelDataBool(AppApiChannel channel, int dataid, Bool  *value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_StoreChannelDataBool(AppApiChannel channel, int dataid, Bool  value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_GetChannelDataInt(AppApiChannel channel, int dataid, int   *value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_StoreChannelDataInt(AppApiChannel channel, int dataid, int   value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_GetChannelDataNat32(AppApiChannel channel, int dataid, Nat32 *value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_StoreChannelDataNat32(AppApiChannel channel, int dataid, Nat32 value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_GetChannelDataString(AppApiChannel channel, int dataid, Nat16  *value, int size)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_StoreChannelDataString(AppApiChannel channel, int dataid, Nat16 *value, int size)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_GetDigitalChannel(AppApiChannel* channel, int OnId, int TsId, int Sid, int Ptc)
{
	HsvPgdatDigServiceData  svcdat,querysvcdat;
	Bool Found = FALSE;
    FResult ret = err_Ok;
	int from = 0, to = 0, index;

	querysvcdat.OriginalNetworkId = OnId;
	querysvcdat.ServiceId = Sid;
	if(ipgdb_GetRange(CURRENT_D_SVC_TABLE,2,(Address) &querysvcdat,&from,&to))
	{	
		for (index = from ; index <= to; index++)
		{
			if(ipgdb_GetByIndex( CURRENT_D_SVC_TABLE, index, (Address) &svcdat))
			{
				if(((svcdat.Tsid == TsId) && (VALID_TSID(TsId))) || (!VALID_TSID(TsId)))
				{
					Found = TRUE;
					break;
				}
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_LoadChannelTable(char* dir)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_SaveChannelTable(char* dir)
{
    return chmapop_SaveChannelTable(ipgdb_GetCurrentTable(), dir);
}

AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_LoadChannelTableFromMedium(char* dir, int medium) 
{
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_SaveChannelTableToMedium(char* dir, int medium) 
{
	FResult ret = err_Ok;   
#if 0
	memset(mPgdatMsg.DirectoryPath, 0x00, sizeof(mPgdatMsg.DirectoryPath));
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_SwapChannels(AppApiChannel channel1, AppApiChannel channel2)
{        
    /*Algorithm */
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat_ReorderChannels(AppApiChannel channel1, AppApiChannel channel2, Bool swap)
{
    /* Algorithm */
...
void CHsvProgramData_mpgdat_Priv::pgdat3_ClearCurrentTable(void)
{
    ipgdb_ClearTable(ipgdb_GetCurrentTable());
    chmapop_CommitToFlash(ipgdb_GetCurrentTable());
    chmapop_ChannelTableChanged();
...
void CHsvProgramData_mpgdat_Priv::pgdat3_ClearAllTables(void)
{
    ipgdb_ClearTable(ipgdb_GetCurrentTable());
    chmapop_CommitToFlash(ipgdbconst_Antenna);
    chmapop_CommitToFlash(ipgdbconst_Cable);
...
Bool CHsvProgramData_mpgdat_Priv::pgdat3_IsValidChannel(AppApiChannel channel)
{
    Bool ret = FALSE;
...
Bool CHsvProgramData_mpgdat_Priv::pgdat3_IsChannelInstalled(AppApiChannel *channel )
{
    return pgdat_IsChannelInstalled(channel);
}

Bool CHsvProgramData_mpgdat_Priv::pgdat3_IsAttributeSupported(int attribute)
{
    return mIsAttributeSupported(attribute);
}

AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetChannelDataBool(AppApiChannel channel, int dataid, Bool  *value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_StoreChannelDataBool(AppApiChannel channel, int dataid, Bool  value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetChannelDataInt(AppApiChannel channel, int dataid, int   *value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_StoreChannelDataInt(AppApiChannel channel, int dataid, int   value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetChannelDataNat32(AppApiChannel channel, int dataid, Nat32 *value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_StoreChannelDataNat32(AppApiChannel channel, int dataid, Nat32 value)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetChannelDataString(AppApiChannel channel, int dataid, Nat16  *value, int size)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_StoreChannelDataString(AppApiChannel channel, int dataid, Nat16 *value, int size)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetDigitalChannel(AppApiChannel* channel, int OnId, int TsId, int Sid, int Ptc)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_LoadChannelTable(char* dir)
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_SaveChannelTable(char* dir)
{
    return chmapop_SaveChannelTable(ipgdb_GetCurrentTable(), dir);
}

AppApiReturnCode CHsvProgramData_mpgdat_Priv::mLoadChannelTableFromMedium(char* dir, int medium) 
{
    FResult ret = err_Ok;   
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_LoadChannelTableFromMedium(char* dir, int medium) 
{
	FResult ret = err_Ok;   
#if 0
	memset(mPgdatMsg.DirectoryPath, 0x00, sizeof(mPgdatMsg.DirectoryPath));
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::mSaveChannelTableToMedium(char* dir, int medium) 
{
    FResult ret = err_Ok;   
	Bool	status = FALSE;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_SaveChannelTableToMedium(char* dir, int medium) 
{
	FResult ret = err_Ok;   
#if 0
	memset(mPgdatMsg.DirectoryPath, 0x00, sizeof(mPgdatMsg.DirectoryPath));
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetMediumFromTable (char *dir, int *medium) 
{
    FResult ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_SwapChannels(AppApiChannel channel1, AppApiChannel channel2)
{        
    /*Algorithm */
    /* 1. Check channel isntallation 
       1.1 check whether first channel isntalled
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_ReorderChannels(AppApiChannel channel1, AppApiChannel channel2, Bool swap)
{
    /* Algorithm */
    /*  1. Get the digits of both channels
        1.1 Get the digit of channel1
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetNoOfBarkerMultiplexes(int *NoOfMuxes)
{
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetBarkerMultiplexByIndex(int index, AppApiMultiplex *muxes)
{
    AppApiReturnCode ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_ReArrangeChannels(AppApiChannel channel1, AppApiChannel channel2)
{
    AppApiReturnCode ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetBarkerMultiplexesForChannel(AppApiChannel channel, int* NoOfMuxes, AppApiMultiplex *muxes)
{
    AppApiReturnCode ret = err_Ok;
    UNUSED(channel);
    UNUSED(NoOfMuxes);
...
void CHsvProgramData_mpgdat_Priv::GetOperator(AppApiOperator * x)
{

}

AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetOperator(AppApiOperator *OperatorId)
{
    AppApiReturnCode ret = err_Ok;
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_StoreChannelDataNat64(AppApiChannel channel, int dataid, Nat64 value)
{
...
AppApiReturnCode CHsvProgramData_mpgdat_Priv::pgdat3_GetChannelDataNat64(AppApiChannel channel, int dataid, Nat64  *value)
{
    FResult ret = err_Ok;
...
FResult CHsvProgramData_mpgdat_Priv::mSetScalarAttributeNat64(AppApiChannel channel, int dataid, Nat64  value)
{
    FResult ret = err_Ok;
    Nat64 oldvalue = 0;
...
FResult CHsvProgramData_mpgdat_Priv::mGetScalarAttributeNat64(AppApiChannel channel, int dataid, Nat64  *value)
{
    FResult ret = err_Ok;
...
FResult CHsvProgramData_mpgdat_Priv::mGetScalarAttribute(AppApiChannel channel, int dataid, Nat32  *value)
{
    FResult ret = err_Ok;
...
#undef  COMMON_ATTRIB
            ...
            else if ((AppApiOnePart == channel.Type) || (AppApiTwoPart == channel.Type) || (AppApiRadio == channel.Type))
            {
                HsvPgdatDigServiceData  svcdat;
...
FResult CHsvProgramData_mpgdat_Priv::mSetScalarAttribute(AppApiChannel channel, int dataid, Nat32 value)
{
    FResult ret = err_Ok;
    Nat32 oldvalue = 0;
...
Bool CHsvProgramData_mpgdat_Priv::mIsAttributeSupportedNat64(int attribute)
{
    Bool ret = FALSE;
...
Bool CHsvProgramData_mpgdat_Priv::mIsAttributeSupported(int attribute)
{
    Bool ret = FALSE;
...
FResult CHsvProgramData_mpgdat_Priv::ShuffleChannels(ReorderChannelInfo rchannelinfo)
{
...
void CHsvProgramData_mpgdat_Priv::mPgdatThread(void *arg)
{
...
Bool CHsvProgramData_mpgdat_Priv::internalreorder(AppApiChannel channel1, AppApiChannel channel2, Bool DeleteFrist)
{
    Bool retval = FALSE;    
#if 0
...
void CHsvProgramData_mpgdat_Priv::UpdateAnalogOrDigitalTable(HsvPgdatPresetData presetdat)
{
...
void CHsvProgramData_mpgdat_Priv::InstalledSwap(HsvPgdatPresetData Channel1Presetdat, HsvPgdatPresetData Channel2Presetdat)
{
...
void CHsvProgramData_mpgdat_Priv::DeletePresetTables(HsvPgdatPresetData Channel1Presetdat, HsvPgdatPresetData Channel2Presetdat)
{           
    ipgdb_Delete(CURRENT_PRESET_TABLE, (Address)&Channel1Presetdat);
    ipgdb_Delete(CURRENT_PRESET_TABLE, (Address)&Channel2Presetdat);
}

void CHsvProgramData_mpgdat_Priv::InsertPresetTables(HsvPgdatPresetData Channel1Presetdat, HsvPgdatPresetData Channel2Presetdat)
{
    Channel1Presetdat.UniqueNodeId  = -1;// Invalid Node id 
    Channel2Presetdat.UniqueNodeId  = -1;// Invalid Node id 
    ipgdb_Add(CURRENT_PRESET_TABLE, (Address)&Channel1Presetdat);
...
void CHsvProgramData_mpgdat_Priv::UpdateServiceTable(HsvPgdatDigServiceData  svcdat, int PresetNumber)
{
    if(ipgdb_GetByKey(CURRENT_D_SVC_TABLE, (Address)&svcdat))
    {
