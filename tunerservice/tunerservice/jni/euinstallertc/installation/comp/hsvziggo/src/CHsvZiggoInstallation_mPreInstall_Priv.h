#ifndef  _CHSVZIGGOINSTALLATION_MPREINSTALL_PRIV_H
#define  _CHSVZIGGOINSTALLATION_MPREINSTALL_PRIV_H 
...
#define CLASSSCOPE CHsvZiggoInstallation_mPreInstall_Priv::
#include "locals_mPreInstall.h"

class CHsvZiggoInstallation_mPreInstall_Priv : public CTCMwBase
{
public:
virtual ~CHsvZiggoInstallation_mPreInstall_Priv();
...
//Provided interfaces
private:
IHsvDigitalScanImpl(CHsvZiggoInstallation_mPreInstall_Priv,ipreins);
IHsvSdmControlNotifyExImpl(CHsvZiggoInstallation_mPreInstall_Priv,ipreinsctrlN);
IHsvFrontEndApiNotifyImpl(CHsvZiggoInstallation_mPreInstall_Priv,ipreinsfeapiN);
IHsvPowerImpl(CHsvZiggoInstallation_mPreInstall_Priv,ipreinspow);
public:
...
private:
Pumpdefines(CHsvZiggoInstallation_mPreInstall_Priv);

public:
CHsvZiggoInstallation_mPreInstall_Priv():i__ipreins(this),i__ipreinsctrlN(this),i__ipreinsfeapiN(this),i__ipreinspow(this)
{
ipreins	=	&i__ipreins;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvZiggoInstallation_mPreInstall_Priv::func,replace,(char *)name,this)
