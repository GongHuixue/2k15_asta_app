#ifndef  _CHSVZIGGOINSTALLATION_MDTR_PRIV_H
#define  _CHSVZIGGOINSTALLATION_MDTR_PRIV_H 
...
#define CLASSSCOPE CHsvZiggoInstallation_mDtr_Priv::
#include "locals_mDtr.h"

class CHsvZiggoInstallation_mDtr_Priv : public CTCMwBase
{
public:
virtual ~CHsvZiggoInstallation_mDtr_Priv();
...
//Provided interfaces
private:
IHsvDigitalScanImpl(CHsvZiggoInstallation_mDtr_Priv,idtr);
IHsvFrontEndApiNotifyImpl(CHsvZiggoInstallation_mDtr_Priv,idtrfeapiN);
IHsvPowerImpl(CHsvZiggoInstallation_mDtr_Priv,idtrpow);
public:
...
private:
Pumpdefines(CHsvZiggoInstallation_mDtr_Priv);

public:
CHsvZiggoInstallation_mDtr_Priv():i__idtr(this),i__idtrfeapiN(this),i__idtrpow(this)
{
idtr	=	&i__idtr;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvZiggoInstallation_mDtr_Priv::func,replace,(char *)name,this)
