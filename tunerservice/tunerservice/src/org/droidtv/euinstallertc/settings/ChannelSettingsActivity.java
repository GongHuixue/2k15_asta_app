...
public class ChannelSettingsActivity extends Activity implements Observer
{
	private static final String TAG = ChannelSettingsActivity.class.getName();
	private SettingsHandler mSettingsHandler;
	private EasyPqView mEasyPQView;
	private ChannelSettingsActivity m_context;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if(m_wrapper.ifRecordingIsInProgress()){
			...
			View l_settingsView = l_inflater.inflate(R.layout.channel_settings_layout, null);
			...
			m_wrapper.setUseHtvDTRTuneType(false,false);
	...
	class InitAsyncTask extends AsyncTask<String, Void, String>{
		...
		protected void onPostExecute(String result)
		{
			...
			} else if (result.equals(INIT_UI))
			{
				...
				MenuItem mi = new CustomMenuInflater(m_context).inflateMenu(R.menu.settings_menu, getResources());
