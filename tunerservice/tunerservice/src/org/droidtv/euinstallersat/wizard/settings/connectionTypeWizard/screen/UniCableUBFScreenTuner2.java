...
public class UniCableUBFScreenTuner2 extends WizardStep implements ConnTypeScreen, OnFocusChangeListener
{

	private static final String TAG = UniCableUBFScreenTuner2.class.getName();
	...
	public UniCableUBFScreenTuner2(Context context, AttributeSet attrSet, int defStyle)
	{
		super(context, attrSet, defStyle);
		m_context = context;
		m_wrapper = NativeAPIWrapper.getInstance();
		m_ntfHandler = NotificationHandler.getInstance();
	//	m_wrapper.setDualTuner(1);
		loadLayout(context);
	}

	public UniCableUBFScreenTuner2(Context context, AttributeSet attrSet)
	{
		this(context, attrSet, 0);
	}

	public UniCableUBFScreenTuner2(Context context)
	{
		this(context, null, 0);
	}
	...
	private void loadLayout(Context context)
	{
		...
		OnClickListener buttonNext_Listener = new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				m_wrapper.SetUnicableUBFreqTuner2(getDisplayedFrequency());
				exitOnFinish(false);
			}
		};
		...
		setHintText(m_context.getString(org.droidtv.ui.strings.R.string.MAIN_WI_SAT_AUTOSTORE_UB_FREQUENCY_TUNER_2));
	}
	...
	{
		return ConnTypeScreenReq.UNICABLEUBF2;
	}
	...
	{
		setDisplayedFrequency(m_wrapper.GetUnicableUBFreqTuner2());
		m_digit_array[0].requestFocus();
