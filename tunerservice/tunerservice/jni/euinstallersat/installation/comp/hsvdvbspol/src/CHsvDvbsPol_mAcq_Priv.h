#ifndef  _CHSVDVBSPOL_MACQ_PRIV_H
#define  _CHSVDVBSPOL_MACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsPol_mAcq_Priv::
#include "locals_mAcq.h"

class CHsvDvbsPol_mAcq_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsPol_mAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbsPol_mAcq_Priv,iacqpow);
IHsvDigitalAcquisitionImpl(CHsvDvbsPol_mAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbsPol_mAcq_Priv);

public:
CHsvDvbsPol_mAcq_Priv():i__iacqpow(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsPol_mAcq_Priv::func,replace,(char *)name,this)
