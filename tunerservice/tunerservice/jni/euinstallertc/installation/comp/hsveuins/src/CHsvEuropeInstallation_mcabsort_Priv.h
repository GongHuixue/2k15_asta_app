#ifndef  _CHSVEUROPEINSTALLATION_MCABSORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MCABSORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mcabsort_Priv::
#include "locals_mcabsort.h"

class CHsvEuropeInstallation_mcabsort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mcabsort_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvEuropeInstallation_mcabsort_Priv,icabpow);
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mcabsort_Priv,idvbcsort);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mcabsort_Priv);

public:
CHsvEuropeInstallation_mcabsort_Priv():i__icabpow(this),i__idvbcsort(this)
{
icabpow	=	&i__icabpow;
idvbcsort	=	&i__idvbcsort;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mcabsort_Priv::func,replace,(char *)name,this)
