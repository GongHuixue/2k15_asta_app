#ifndef IAPPAPICHANNELLIBNVMIDS_H
#define IAPPAPICHANNELLIBNVMIDS_H
#include <intfparam.h>
#include <provreq.h>
class IAppApiChannelLibNvmIds
{
public:
	virtual ~IAppApiChannelLibNvmIds(){}
...
#define IAppApiChannelLibNvmIdsImpl(Comp,intf)    \
...
friend class InterfaceParam<Comp,NvmId>;\
friend class InterfaceParam<Comp,NvmId>;\
class Comp ## _ ## intf : public IAppApiChannelLibNvmIds \
{\
private:\
    Comp *m_parent; \
public: \
