#ifndef  _CHSVZIGGOINSTALLATION_MBACKGROUND_PRIV_H
#define  _CHSVZIGGOINSTALLATION_MBACKGROUND_PRIV_H 
...
#define CLASSSCOPE CHsvZiggoInstallation_mBackground_Priv::
#include "locals_mBackground.h"

class CHsvZiggoInstallation_mBackground_Priv : public CTCMwBase
{
public:
virtual ~CHsvZiggoInstallation_mBackground_Priv();
...
//Provided interfaces
private:
IEnableImpl(CHsvZiggoInstallation_mBackground_Priv,ena);
IHsvDigitalScanImpl(CHsvZiggoInstallation_mBackground_Priv,ibckg);
IHsvSdmControlNotifyExImpl(CHsvZiggoInstallation_mBackground_Priv,ibckgctrlN);
IHsvPowerImpl(CHsvZiggoInstallation_mBackground_Priv,ibckgpow);
IHsvSortNotifyImpl(CHsvZiggoInstallation_mBackground_Priv,sortN);
IHsvStreamNotifyImpl(CHsvZiggoInstallation_mBackground_Priv,strapiN);
public:
...
private:
Pumpdefines(CHsvZiggoInstallation_mBackground_Priv);

public:
CHsvZiggoInstallation_mBackground_Priv():i__ena(this),i__ibckg(this),i__ibckgctrlN(this),i__ibckgpow(this),i__sortN(this),i__strapiN(this)
{
ena	=	&i__ena;
ibckg	=	&i__ibckg;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvZiggoInstallation_mBackground_Priv::func,replace,(char *)name,this)
