#ifndef  _CHSVDVBSASTRA_MBCKGND_H
#define  _CHSVDVBSASTRA_MBCKGND_H 
...
class CHsvDvbsAstra_mBckgnd: private IHsvSatelliteBackgroundInstallation,IHsvPower,IHsvStreamNotify,public CS2MwBase
{
public:
...
private:
Pumpdefines(CHsvDvbsAstra_mBckgnd);
...
Bool mIsServiceDescriptorAcquired(Nat16* src);
Bool mCheckAndUpdateSdtVersion (Nat32 *TpId);



public:
CHsvDvbsAstra_mBckgnd()
{
...
#define pgdat_GetDigitalChannelForFreesat(channel,OnId,TsId,Sid,Ptc)	pgdat->GetDigitalChannelForFreesat(channel,OnId,TsId,Sid,Ptc)
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsAstra_mBckgnd::func,replace,(char *)name,this)
