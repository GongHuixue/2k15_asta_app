#ifndef  _CHSVCANALDIGITALINSTALLATION_MDATAACQ_H
#define  _CHSVCANALDIGITALINSTALLATION_MDATAACQ_H 
...
class CHsvCanalDigitalInstallation_mDataAcq
{
public:
...
public:
CHsvCanalDigitalInstallation_mDataAcq();
virtual ~CHsvCanalDigitalInstallation_mDataAcq();
private:
CHsvCanalDigitalInstallation_mDataAcq_Priv	*m_priv;
};
