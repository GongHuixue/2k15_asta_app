 ...
 *############################################################
 */
#include "_hsvziggo_mBackground.h"

TRACESYMBOL(m, "dvb/installation/hsvziggo_mBackground")
...
InstStatus CHsvZiggoInstallation_mBackground_Priv::s__mInstStatus;





t_ZiggoCableDSDesc CHsvZiggoInstallation_mBackground_Priv::s__mCableDSDesc;

Nat16 CHsvZiggoInstallation_mBackground_Priv::s__mBarkerMuxONID = 0xFFFF,CHsvZiggoInstallation_mBackground_Priv::s__mBarkerMuxTSID = 0xFFFF;
...
Bool CHsvZiggoInstallation_mBackground_Priv::s__VersionUpdateNeeded = FALSE;


Nat16 CHsvZiggoInstallation_mBackground_Priv:: s__OnId = 0xFFFF;
Nat16 CHsvZiggoInstallation_mBackground_Priv:: s__SrvId = 0xFFFF;
Nat16 CHsvZiggoInstallation_mBackground_Priv:: s__TsId = 0xFFFF;
Nat16 CHsvZiggoInstallation_mBackground_Priv:: s__CachedPresetnumber = 0xFFFF;
Nat32 CHsvZiggoInstallation_mBackground_Priv:: s__CachedFrequency = 0;

Bool CHsvZiggoInstallation_mBackground_Priv:: s__mServiceUpdateInProgress = FALSE;
Bool CHsvZiggoInstallation_mBackground_Priv:: s__mBackgroundUpdateInProgress = FALSE;

Bool CHsvZiggoInstallation_mBackground_Priv::s__mServiceNameUpdated = FALSE;
Bool CHsvZiggoInstallation_mBackground_Priv::s__mNitUpdatedAlsoHappened = FALSE;





const FunctionVoid CHsvZiggoInstallation_mBackground_Priv::EventActionMatrix[][StMax] =
{
...
/* static variables */
Bool CHsvZiggoInstallation_mBackground_Priv::s__mActive,CHsvZiggoInstallation_mBackground_Priv::s__mDirtyBit,CHsvZiggoInstallation_mBackground_Priv::s__mDataAcquistion;
Bool CHsvZiggoInstallation_mBackground_Priv::s__mPresetChanged,CHsvZiggoInstallation_mBackground_Priv::s__mLowestPreset;


Pump CHsvZiggoInstallation_mBackground_Priv::s__mInstallPump;


void CHsvZiggoInstallation_mBackground_Priv::mPumpHandler(int event, Nat32 param)
{
    UNUSED(param);
...
inline void CHsvZiggoInstallation_mBackground_Priv::FuncStartInstallation(void)
{
    ...
    TraceDebug(m,"%s %d CurrentFreq %lu CurrentNITVersionInDb %d NITVersionFromDmx %d", __FUNCTION__, __LINE__, CachedFrequency, CurrentNITVersion, mGetVersion(NIT_DATA));
    if( VersionUpdateNeeded || ((mGetVersion(NIT_DATA) != 0xFF) && (mGetVersion(NIT_DATA) != CurrentNITVersion)) )
    {
        ...
        if(mInstStatus.TargeNITFound == FALSE)
        {
            ...
            TraceDebug(m,"%s %d No proper data available", __FUNCTION__, __LINE__);
            mInitialise();
        }
    ...
    {
        TraceDebug(m,"%s %d no version change", __FUNCTION__, __LINE__);
            mInitialise();
    }
}

inline void CHsvZiggoInstallation_mBackground_Priv::FuncStopInstallation(void)
{
    mInitialise();
...
inline void CHsvZiggoInstallation_mBackground_Priv::FuncComplete(void)
{
...
inline void CHsvZiggoInstallation_mBackground_Priv::FuncSdtOtherComplete(void)
{
...
inline void CHsvZiggoInstallation_mBackground_Priv::mInitialise(void)
{
...
inline Bool CHsvZiggoInstallation_mBackground_Priv::mAcquireValidNit(void)
{
    int hsvspid = 0;
    Bool retval = FALSE;
    ...
    {
        TraceDebug(m,"%s %d Actual NetworkId %d mInstStatus.TargetNITValue %d", __FUNCTION__, __LINE__, NetworkId,mInstStatus.TargetNITValue);
...
void CHsvZiggoInstallation_mBackground_Priv::mClearAndSyncDatabase (void)
{	
...
void CHsvZiggoInstallation_mBackground_Priv::mDeleteServicesRemoved (void)
{
...
void CHsvZiggoInstallation_mBackground_Priv::mAddOrUpdateServiceRecords (void)
{
...
void CHsvZiggoInstallation_mBackground_Priv::mAssignPgdbKeys (int TableId, Address Data, Address TempData)
{
...
Nat8 CHsvZiggoInstallation_mBackground_Priv::mGetVersion(int TableData)
{
    Nat8 retval = 0xFF;
    ...
    TraceDebug(m,"%s %d NetworkId %d VersionNumber : %d ",__FUNCTION__,__LINE__, mInstStatus.TargetNITValue, retval);
    return retval;
}
void CHsvZiggoInstallation_mBackground_Priv::ena_Enable(void)
{
    TraceDebug(m,"%s %d mActive %d", __FUNCTION__, __LINE__, mActive);
    mActive = TRUE;
	mInstStatus.TargetNITValue = dvbset_GetAttribute(AUTO_MODE, rins_AttributeNetworkId);
	mServiceUpdateInProgress = FALSE;
	/* Enabling the SDT other always for Telenet zapping */
	idataacq_Enable();
}

void CHsvZiggoInstallation_mBackground_Priv::ena_Disable(void)
{
    TraceDebug(m,"%s %d mActive %d", __FUNCTION__, __LINE__, mActive);
    mActive = FALSE;
...
void CHsvZiggoInstallation_mBackground_Priv::ibckgpow_Init(void)
{
    mInstallPump = pmp_PmpCreateEx(pen_PumpEngine, mPumpHandler, TRUE, "hsvziggo_mBackground");
    VersionUpdateNeeded = FALSE;
    mInitialise();
}

void CHsvZiggoInstallation_mBackground_Priv::ibckgctrlN_OnEvent( HsvDemux dmx, int eventid, int value )
{
    UNUSED(dmx);
    TraceDebug(m,"%s %d mActive %d BACKGROUND_INSTALL %d eventid %d value %d mDirtyBit %d", __FUNCTION__, __LINE__, mActive, BACKGROUND_INSTALL, eventid, value, mDirtyBit);
...
int CHsvZiggoInstallation_mBackground_Priv::ibckg_ZiggoGetSDTType(Nat16 Frequency)
{
    return mGetSDTType(Frequency);
}

void CHsvZiggoInstallation_mBackground_Priv::ibckg_ZiggoGetPTCInfo(HsvInstallationPTC *ptc, Nat16 Onid, Nat16 Tsid)
{
    mGetPTCInfo(ptc, Onid, Tsid);
}

void CHsvZiggoInstallation_mBackground_Priv::sortN_OnEvent(int eventid, int value)
{
    UNUSED(value);
...
void CHsvZiggoInstallation_mBackground_Priv::plfresN_OnResourceLost( Nat32 resources )
{
    TraceDebug(m,"%s %d resources %ld", __FUNCTION__, __LINE__, resources);
...
void CHsvZiggoInstallation_mBackground_Priv::strapiN_OnAdded( HsvDestination dest, int spid, int key1, int key2, int key3)
{
...
Bool CHsvZiggoInstallation_mBackground_Priv::ibckg_GetAltTSValues(Nat16* ONID, Nat16* TSID)
{
    UNUSED(ONID);
    UNUSED(TSID);
    return FALSE;
...
void CHsvZiggoInstallation_mBackground_Priv::ibckg_GetSIDetails(HsvSDMSIDataValues* sivalues)
{
	return;
}


int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetTargetNitType(Nat16* NetworkId)
{
...
FResult CHsvZiggoInstallation_mBackground_Priv::ibckg_StopInstallation(void)
{ 
...
void CHsvZiggoInstallation_mBackground_Priv::ibckgpow_TurnOn(void)
{ }
void CHsvZiggoInstallation_mBackground_Priv::ibckgpow_TurnOff(void)
{ }
void CHsvZiggoInstallation_mBackground_Priv::ibckg_Initialise()
{ }
FResult CHsvZiggoInstallation_mBackground_Priv::ibckg_StartInstallation(int source, int ptc, int mode)
{ 
    UNUSED(source);
    UNUSED(ptc);
    UNUSED(mode);
...
FResult CHsvZiggoInstallation_mBackground_Priv::ibckg_StartDigitalScan(void)
{ return 0; }
FResult CHsvZiggoInstallation_mBackground_Priv::ibckg_StartDigitalTuning(int frequency)
{   UNUSED(frequency); return 0; }
FResult CHsvZiggoInstallation_mBackground_Priv::ibckg_StopDigitalScan (void)
{ return 0; }
int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetNoOfPass(void)
{ return 0; }
int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetCurrentPass ( void )
{ return 0; }
FResult CHsvZiggoInstallation_mBackground_Priv::ibckg_StoreWeakSignalInstallationChannel()
{ return 0; }
int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetNumberOfDigitalChannelsFound()
{ return 0; }
int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetNumberOfDigitalChannelsRemoved()
{ return 0; }
int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetCurrentState()
{ return 0; }
Bool CHsvZiggoInstallation_mBackground_Priv::ibckg_GetCurTSValues( Nat16* ONID, Nat16* TSID )
{ 
    UNUSED(ONID);
    UNUSED(TSID);
    return 0; 
}    
HsvStreamPriority CHsvZiggoInstallation_mBackground_Priv::ibckg_GetStreamPriority(void)
{ return (HsvStreamPriority)0; }
HsvHierarchyMode CHsvZiggoInstallation_mBackground_Priv::ibckg_GetHierarchyMode(void)
{ return (HsvHierarchyMode)0; }
void CHsvZiggoInstallation_mBackground_Priv::ibckg_SetStreamPriority (HsvStreamPriority prio)
{
    UNUSED(prio);
}
void CHsvZiggoInstallation_mBackground_Priv::ibckg_SyncComplete(void)
{ }
void CHsvZiggoInstallation_mBackground_Priv::ibckg_ClearCache(void)
{ }
int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetPLPIds(int *PLPIds)
{ 
    UNUSED(PLPIds);
    return 0; 
}
int CHsvZiggoInstallation_mBackground_Priv::ibckg_GetSDTType()
{ return 0; }
void CHsvZiggoInstallation_mBackground_Priv::ibckg_GetPTCInfo(HsvInstallationPTC *ptc)
{ UNUSED(ptc); }
void CHsvZiggoInstallation_mBackground_Priv::ibckg_GetEpgBarkerMux(Nat16 *ONID, Nat16 *TSID)
{
    UNUSED(ONID);
    UNUSED(TSID);
}

Bool CHsvZiggoInstallation_mBackground_Priv::ibckg_ZiggoNetworkDataSet(Bool ActionValue)
{
    UNUSED(ActionValue);
    return FALSE;
}

void CHsvZiggoInstallation_mBackground_Priv::ibckg_ClearPersistent()
{
    
}
Bool CHsvZiggoInstallation_mBackground_Priv::mCompareUnicodeString(Nat16* dest, Nat16* src)
{
	Bool retval = TRUE;
...
void CHsvZiggoInstallation_mBackground_Priv::strapiN_OnCompleted         ( HsvDestination dest, int spid)
{
...
void CHsvZiggoInstallation_mBackground_Priv::HandleTelenetSdtOtherNameUpdate(HsvDestination dest, int spid, int Onid, int ServiceId, int Tsid, int eventid)
{
        ...
        if(TRUE == strapi_GetByKey(dest, HSVSPID(OtherSDTSection, dvb, sdt), Onid, Tsid, ServiceId, &other_service))
        {
            ...
            {            	
				...
				if ( (0 == ret) && (mCompareUnicodeString(other_service.ServiceName, ChannelName) == FALSE) )
				{
					...
					if(IHsvErrorCodeEx_Ok == pgdat_StoreChannelDataString(svcChannel, pgdat_StringExtChannelName, other_service.ServiceName, (eurdiv_ChannelNameLength-1)))
					{
						
						//Below fix is done to  manage the logo update for services whose names are change before/after
						//logo association triggered after background installation.
						ret = pgdat_StoreChannelDataInt(svcChannel,pgdat_IntLogoURL,-1);
					}
					
					TraceNotice(m,"Telenet : Updated channel name in background inst : %d %s ret %d", __LINE__, __FUNCTION__,ret);
...
void CHsvZiggoInstallation_mBackground_Priv::strapiN_OnChanged           ( HsvDestination dest, int spid, int key1, int key2, int key3, int eventid)
{
...
void CHsvZiggoInstallation_mBackground_Priv::strapiN_OnRemoved           ( HsvDestination dest, int spid, int key1, int key2, int key3)
{
	return;
}

int CHsvZiggoInstallation_mBackground_Priv::mMapFromHsvToPlfDvbcModulation(int InputModulation)
{
...
inline int CHsvZiggoInstallation_mBackground_Priv::mGetSDTType(Nat16 Frequency)
{
...
inline void CHsvZiggoInstallation_mBackground_Priv::mGetPTCInfo(HsvInstallationPTC *ptc, Nat16 Onid, Nat16 Tsid)
{
    int i = 0;
...
inline Bool CHsvZiggoInstallation_mBackground_Priv::mLoadCDSDFromStrapi(int hsvspid)
{
    int i, j;
    ...
    for(i = 0; i < mCableDSDesc.NumOfTs; i++ )
    {
        if(strapi_GetByIndex(HsvMain, hsvspid, i, (void*)(&CableDSDesc)))
        {
            ...
            for(j = 0; j < CableDSDesc.NumOfCDSD; j++)
            {
                ...
                TraceDebug(m,"CDS:: Frequency %d\nModulation %d\nSymbolRate %d", (CableDSDesc.CDSD[j].Frequency>>4), CableDSDesc.CDSD[j].Modulation, CableDSDesc.CDSD[j].SymbolRate);
            }
        }
        else
        {
...
inline Bool CHsvZiggoInstallation_mBackground_Priv::mGetAltTSValues(Nat16* ONID, Nat16* TSID)
{
    UNUSED(ONID);
    UNUSED(TSID);
    return TRUE;
...
inline void CHsvZiggoInstallation_mBackground_Priv::mGetEpgBarkerMux(Nat16 *ONID, Nat16 *TSID)
{
    *ONID = mBarkerMuxONID; *TSID = mBarkerMuxTSID;
}

Bool CHsvZiggoInstallation_mBackground_Priv::mCheckVisibleService(HsvPgdatPresetData* preset)
{
...
void CHsvZiggoInstallation_mBackground_Priv::tuneToLowestPreset()
{
	HsvPgdatDigServiceData  svcdat_temp;
