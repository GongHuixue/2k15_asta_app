#ifndef  _CHSVDVBSCANAL_MSCAN_PRIV_H
#define  _CHSVDVBSCANAL_MSCAN_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsCanal_mScan_Priv::
#include "locals_mScan.h"

class CHsvDvbsCanal_mScan_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsCanal_mScan_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionNotifyImpl(CHsvDvbsCanal_mScan_Priv,idataacqN);
IHsvSatellitePackageInstallationImpl(CHsvDvbsCanal_mScan_Priv,isvcscan);
IHsvSdmControlNotifyExImpl(CHsvDvbsCanal_mScan_Priv,isvcscanctrlN);
IHsvDigitalScanDataImpl(CHsvDvbsCanal_mScan_Priv,isvcscandata);
IHsvPowerImpl(CHsvDvbsCanal_mScan_Priv,isvcscanpow);
IHsvSatelliteFrontEndNotifyImpl(CHsvDvbsCanal_mScan_Priv,plfApidvbsN);
public:
...
private:
Pumpdefines(CHsvDvbsCanal_mScan_Priv);

public:
CHsvDvbsCanal_mScan_Priv():i__idataacqN(this),i__isvcscan(this),i__isvcscanctrlN(this),i__isvcscandata(this),i__isvcscanpow(this),i__plfApidvbsN(this)
{
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsCanal_mScan_Priv::func,replace,(char *)name,this)
