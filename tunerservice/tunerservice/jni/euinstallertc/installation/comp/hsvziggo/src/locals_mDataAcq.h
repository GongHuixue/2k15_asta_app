...
t_ZiggoServiceList mSvcListData;
static t_ZiggoServiceList s__mSvcListData;
int mDigitalChannelsFound;
static int s__mDigitalChannelsFound;
Bool updateBarkerMuxZiggo;
static Bool s__updateBarkerMuxZiggo;
...
inline Bool mOperatorZiggoInstallRules(HsvPgdatDigServiceData *svcdat);
...
void mUpdateServiceNameForTelenet(HsvPgdatDigServiceData* psvcdat);
void module__init(void){
	...
	updateBarkerMuxZiggo	=	s__updateBarkerMuxZiggo;
}
Bool mZiggoNetwork();
