#ifndef  _CHSVEUROPEINSTALLATION_MHUNGARYORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MHUngarySORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mhungarysort_Priv::
#include "locals_mhungarysort.h"

class CHsvEuropeInstallation_mhungarysort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mhungarysort_Priv();
...
//Provided interfaces
private:
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mhungarysort_Priv,idvbthungarysort);
IHsvPowerImpl(CHsvEuropeInstallation_mhungarysort_Priv,idvbthungarysortpow);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mhungarysort_Priv);

public:
CHsvEuropeInstallation_mhungarysort_Priv():i__idvbthungarysort(this),i__idvbthungarysortpow(this)
{
idvbthungarysort	=	&i__idvbthungarysort;
idvbthungarysortpow	=	&i__idvbthungarysortpow;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mhungarysort_Priv::func,replace,(char *)name,this)
