#ifndef  _CHSVDVBSTRICOLOR_MSCAN_PRIV_H
#define  _CHSVDVBSTRICOLOR_MSCAN_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsTricolor_mScan_Priv::
#include "locals_mScan.h"

class CHsvDvbsTricolor_mScan_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsTricolor_mScan_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionNotifyImpl(CHsvDvbsTricolor_mScan_Priv,idataacqN);
IHsvSatellitePackageInstallationImpl(CHsvDvbsTricolor_mScan_Priv,isvcscan);
IHsvSdmControlNotifyExImpl(CHsvDvbsTricolor_mScan_Priv,isvcscanctrlN);
IHsvDigitalScanDataImpl(CHsvDvbsTricolor_mScan_Priv,isvcscandata);
IHsvPowerImpl(CHsvDvbsTricolor_mScan_Priv,isvcscanpow);
IHsvSatelliteFrontEndNotifyImpl(CHsvDvbsTricolor_mScan_Priv,plfApidvbsN);
public:
...
private:
Pumpdefines(CHsvDvbsTricolor_mScan_Priv);

public:
CHsvDvbsTricolor_mScan_Priv():i__idataacqN(this),i__isvcscan(this),i__isvcscanctrlN(this),i__isvcscandata(this),i__isvcscanpow(this),i__plfApidvbsN(this)
{
...
#define idataacq_GetTricolorRegionNames(names, len)	idataacq->GetTricolorRegionNames(names, len)
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsTricolor_mScan_Priv::func,replace,(char *)name,this)
