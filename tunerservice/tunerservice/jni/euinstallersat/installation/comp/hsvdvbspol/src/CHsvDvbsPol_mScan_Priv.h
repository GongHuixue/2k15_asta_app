#ifndef  _CHSVDVBSPOL_MSCAN_PRIV_H
#define  _CHSVDVBSPOL_MSCAN_PRIV_H 
...
#include <CS2MwBase.h>
class CHsvDvbsPol_mScan_Priv;
#define CLASSSCOPE CHsvDvbsPol_mScan_Priv::
#include "locals_mScan.h"

class CHsvDvbsPol_mScan_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsPol_mScan_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionNotifyImpl(CHsvDvbsPol_mScan_Priv,idataacqN);
IHsvSatellitePackageInstallationImpl(CHsvDvbsPol_mScan_Priv,isvcscan);
IHsvSdmControlNotifyExImpl(CHsvDvbsPol_mScan_Priv,isvcscanctrlN);
IHsvDigitalScanDataImpl(CHsvDvbsPol_mScan_Priv,isvcscandata);
IHsvPowerImpl(CHsvDvbsPol_mScan_Priv,isvcscanpow);
IHsvSatelliteFrontEndNotifyImpl(CHsvDvbsPol_mScan_Priv,plfApidvbsN);
public:
...
private:
Pumpdefines(CHsvDvbsPol_mScan_Priv);

public:
CHsvDvbsPol_mScan_Priv():i__idataacqN(this),i__isvcscan(this),i__isvcscanctrlN(this),i__isvcscandata(this),i__isvcscanpow(this),i__plfApidvbsN(this)
{
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsPol_mScan_Priv::func,replace,(char *)name,this)
