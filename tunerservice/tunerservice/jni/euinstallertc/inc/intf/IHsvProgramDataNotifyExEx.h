#ifndef IHSVPROGRAMDATANOTIFYEXEX_H
#define IHSVPROGRAMDATANOTIFYEXEX_H
#include <intfparam.h>
#include <provreq.h>
class IHsvProgramDataNotifyExEx
{
public:
	virtual ~IHsvProgramDataNotifyExEx(){}
	#define IHsvProgramDataNotifyExEx_MajorChannel		((int)0 )
	#define IHsvProgramDataNotifyExEx_MinorChannel		((int)1 )
	#define IHsvProgramDataNotifyExEx_PIDs		((int)2 )
...
#define IHsvProgramDataNotifyExExImpl(Comp,intf)    \
...
class Comp ## _ ## intf : public IHsvProgramDataNotifyExEx \
{\
private:\
    Comp *m_parent; \
public: \
