...
int mCurrentCookie;
static int s__mCurrentCookie;
Bool mStopPending;
static Bool s__mStopPending;
...
inline void FuncComplete(Nat32 param);
void module__init(void){
	...
	mCurrentCookie  = s__mCurrentCookie;
	mStopPending	= s__mStopPending;
}
#endif //MEMBERVARS
