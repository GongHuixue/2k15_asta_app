#ifndef  _CHSVDVBSRUSSIA_MSCAN_PRIV_H
#define  _CHSVDVBSRUSSIA_MSCAN_PRIV_H 
...
#include <CS2MwBase.h>
class CHsvDvbsRussia_mScan_Priv;
#define CLASSSCOPE CHsvDvbsRussia_mScan_Priv::
#include "locals_mScan.h"

class CHsvDvbsRussia_mScan_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsRussia_mScan_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionNotifyImpl(CHsvDvbsRussia_mScan_Priv,idataacqN);
IHsvSatellitePackageInstallationImpl(CHsvDvbsRussia_mScan_Priv,isvcscan);
IHsvSdmControlNotifyExImpl(CHsvDvbsRussia_mScan_Priv,isvcscanctrlN);
IHsvDigitalScanDataImpl(CHsvDvbsRussia_mScan_Priv,isvcscandata);
IHsvPowerImpl(CHsvDvbsRussia_mScan_Priv,isvcscanpow);
IHsvSatelliteFrontEndNotifyImpl(CHsvDvbsRussia_mScan_Priv,plfApidvbsN);
public:
...
private:
Pumpdefines(CHsvDvbsRussia_mScan_Priv);

public:
CHsvDvbsRussia_mScan_Priv():i__idataacqN(this),i__isvcscan(this),i__isvcscanctrlN(this),i__isvcscandata(this),i__isvcscanpow(this),i__plfApidvbsN(this)
{
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsRussia_mScan_Priv::func,replace,(char *)name,this)
