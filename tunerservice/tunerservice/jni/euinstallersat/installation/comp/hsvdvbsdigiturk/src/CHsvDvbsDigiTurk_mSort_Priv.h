#ifndef  _CHSVDVBSDIGITURK_MSORT_PRIV_H
#define  _CHSVDVBSDIGITURK_MSORT_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsDigiTurk_mSort_Priv::
#include "locals_mSort.h"

class CHsvDvbsDigiTurk_mSort_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsDigiTurk_mSort_Priv();
...
//Provided interfaces
private:
IHsvSortingImpl(CHsvDvbsDigiTurk_mSort_Priv,isort);
IHsvPowerImpl(CHsvDvbsDigiTurk_mSort_Priv,isortpow);
public:
...
private:
Pumpdefines(CHsvDvbsDigiTurk_mSort_Priv);

public:
CHsvDvbsDigiTurk_mSort_Priv():i__isort(this),i__isortpow(this)
{
isort	=	&i__isort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsDigiTurk_mSort_Priv::func,replace,(char *)name,this)
