#ifndef  _CHSVDVBSFRANSAT_MSCAN_PRIV_H
#define  _CHSVDVBSFRANSAT_MSCAN_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsFransat_mScan_Priv::
#include "locals_mScan.h"

class CHsvDvbsFransat_mScan_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsFransat_mScan_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionNotifyImpl(CHsvDvbsFransat_mScan_Priv,idataacqN);
IHsvSatellitePackageInstallationImpl(CHsvDvbsFransat_mScan_Priv,isvcscan);
IHsvSdmControlNotifyExImpl(CHsvDvbsFransat_mScan_Priv,isvcscanctrlN);
IHsvDigitalScanDataImpl(CHsvDvbsFransat_mScan_Priv,isvcscandata);
IHsvPowerImpl(CHsvDvbsFransat_mScan_Priv,isvcscanpow);
IHsvSatelliteFrontEndNotifyImpl(CHsvDvbsFransat_mScan_Priv,plfApidvbsN);
public:
...
private:
Pumpdefines(CHsvDvbsFransat_mScan_Priv);

public:
CHsvDvbsFransat_mScan_Priv():i__idataacqN(this),i__isvcscan(this),i__isvcscanctrlN(this),i__isvcscandata(this),i__isvcscanpow(this),i__plfApidvbsN(this)
{
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsFransat_mScan_Priv::func,replace,(char *)name,this)
