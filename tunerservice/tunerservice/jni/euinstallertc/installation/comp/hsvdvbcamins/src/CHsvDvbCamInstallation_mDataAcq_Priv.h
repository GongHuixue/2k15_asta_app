#ifndef  _CHSVDVBCAMINSTALLATION_MDATAACQ_PRIV_H
#define  _CHSVDVBCAMINSTALLATION_MDATAACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbCamInstallation_mDataAcq_Priv::
#include "locals_mDataAcq.h"

class CHsvDvbCamInstallation_mDataAcq_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbCamInstallation_mDataAcq_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionImpl(CHsvDvbCamInstallation_mDataAcq_Priv,idataacq);
IHsvCamScanHelperImpl(CHsvDvbCamInstallation_mDataAcq_Priv,pcamhelper);
public:
...
public:
CHsvDvbCamInstallation_mDataAcq_Priv():i__idataacq(this),i__pcamhelper(this)
{
idataacq	=	&i__idataacq;
pcamhelper = &i__pcamhelper;
module__init();
params__init();
}
...
#define icamhelper_iPresent() (icamhelper.Present())
#define icamhelper_CamNitParser_Parser(dest,cookie,DataSize,DataPtr)	icamhelper->CamNitParser_Parser(dest,cookie,DataSize,DataPtr)
#define icamhelper_GetCamInstallationMode()	icamhelper->GetCamInstallationMode()
#define icamhelper_SetCharacterCode(charCode)	icamhelper->SetCharacterCode(charCode)
...
#define sort_Sort()	sort->Sort()
#define sort_UpdateDigitalPreset(psvcdat)	sort->UpdateDigitalPreset(psvcdat)
