#ifndef  _CHSVDVBCINSTALLATION_MGRID_PRIV_H
#define  _CHSVDVBCINSTALLATION_MGRID_PRIV_H 
...
#define CLASSSCOPE CHsvDvbCInstallation_mgrid_Priv::
#include "locals_mgrid.h"

class CHsvDvbCInstallation_mgrid_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbCInstallation_mgrid_Priv();
...
//Provided interfaces
private:
IHsvSdmControlNotifyExImpl(CHsvDvbCInstallation_mgrid_Priv,igctrlN);
IEnableImpl(CHsvDvbCInstallation_mgrid_Priv,igena);
IHsvDigitalScanImpl(CHsvDvbCInstallation_mgrid_Priv,igrid);
IHsvFrontEndApiNotifyImpl(CHsvDvbCInstallation_mgrid_Priv,igridfeN);
IHsvPowerImpl(CHsvDvbCInstallation_mgrid_Priv,igridpow);
IHsvStreamNotifyImpl(CHsvDvbCInstallation_mgrid_Priv,igstrapiN);
public:
...
private:
Pumpdefines(CHsvDvbCInstallation_mgrid_Priv);

public:
CHsvDvbCInstallation_mgrid_Priv():i__igctrlN(this),i__igena(this),i__igrid(this),i__igridfeN(this),i__igridpow(this),i__igstrapiN(this)
{
igctrlN	=	&i__igctrlN;
igena	=	&i__igena;
igrid	=	&i__igrid;
igridfeN	=	&i__igridfeN;
igridpow	=	&i__igridpow;
igstrapiN	=	&i__igstrapiN;
module__init();
params__init();
}
...
#define igridN_iPresent() (igridN.Present())
...
#define igridN_OnEvent(event)	igridN->OnEvent(event)
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbCInstallation_mgrid_Priv::func,replace,(char *)name,this)
