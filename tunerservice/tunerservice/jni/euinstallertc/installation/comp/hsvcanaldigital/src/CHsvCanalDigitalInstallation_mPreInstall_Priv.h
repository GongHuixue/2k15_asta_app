#ifndef  _CHSVCANALDIGITALINSTALLATION_MPREINSTALL_PRIV_H
#define  _CHSVCANALDIGITALINSTALLATION_MPREINSTALL_PRIV_H 
...
#define CLASSSCOPE CHsvCanalDigitalInstallation_mPreInstall_Priv::
#include "locals_mPreInstall.h"

class CHsvCanalDigitalInstallation_mPreInstall_Priv : public CTCMwBase
{
public:
virtual ~CHsvCanalDigitalInstallation_mPreInstall_Priv();
...
//Provided interfaces
private:
IHsvDigitalScanImpl(CHsvCanalDigitalInstallation_mPreInstall_Priv,ipreins);
IHsvSdmControlNotifyExImpl(CHsvCanalDigitalInstallation_mPreInstall_Priv,ipreinsctrlN);
IHsvFrontEndApiNotifyImpl(CHsvCanalDigitalInstallation_mPreInstall_Priv,ipreinsfeapiN);
IHsvPowerImpl(CHsvCanalDigitalInstallation_mPreInstall_Priv,ipreinspow);
public:
...
private:
Pumpdefines(CHsvCanalDigitalInstallation_mPreInstall_Priv);

public:
CHsvCanalDigitalInstallation_mPreInstall_Priv():i__ipreins(this),i__ipreinsctrlN(this),i__ipreinsfeapiN(this),i__ipreinspow(this)
{
ipreins	=	&i__ipreins;
ipreinsctrlN	=	&i__ipreinsctrlN;
ipreinsfeapiN	=	&i__ipreinsfeapiN;
ipreinspow	=	&i__ipreinspow;
module__init();
params__init();
}
...
#define ibckg_CanalDigitalGetPTCInfo(ptc,Onid,Tsid)	ibckg->CanalDigitalGetPTCInfo(ptc,Onid,Tsid)
#define ibckg_CanalDigitalGetSDTType(Frequency)	ibckg->CanalDigitalGetSDTType(Frequency)
#define ibckg_GetEpgBarkerMux(ONID,TSID)	ibckg->GetEpgBarkerMux(ONID,TSID)
#define ibckg_CanalDigitalNetworkDataSet(ActionValue)	ibckg->CanalDigitalNetworkDataSet(ActionValue)
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvCanalDigitalInstallation_mPreInstall_Priv::func,replace,(char *)name,this)
...
#define ipreinsN_EventScanStopped	IHsvDigitalScanNotify_EventScanStopped
#define ipreinsN_EventScanCompleted	IHsvDigitalScanNotify_EventScanCompleted
#define ipreinsN_EventScanFailed	IHsvDigitalScanNotify_EventScanFailed
#define ipreinsN_EventTargetNITFound	IHsvDigitalScanNotify_EventTargetNITFound
#define ipena_iPresent() (ipena.Present())
#define ipena_Enable()	ipena->Enable(void)
#define ipena_Disable()	ipena->Disable(void)
#define ipreinsctrlN_iPresent() (ipreinsctrlN.Present())
#define ipreinsctrlN_EventScanStopped	IHsvDigitalScanNotify_EventScanStopped
#define ipreinsctrlN_EventScanCompleted	IHsvDigitalScanNotify_EventScanCompleted
#define ipreinsctrlN_EventScanFailed	IHsvDigitalScanNotify_EventScanFailed
#define ipreinsctrlN_EventTargetNITFound	IHsvDigitalScanNotify_EventTargetNITFound
#define iprescanN_iPresent() (iprescanN.Present())
...
#define iprescanN_OnEvent(event)	iprescanN->OnEvent(event)
