...
public:
	...
	#define ISvcAudioControl4ExEx_AllOutput		((int)0 )
	#define ISvcAudioControl4ExEx_BoolTrue		((int)1 )
	#define ISvcAudioControl4ExEx_BoolFalse		((int)0 )
