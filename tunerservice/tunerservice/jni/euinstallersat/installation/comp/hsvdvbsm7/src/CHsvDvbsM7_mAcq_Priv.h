#ifndef  _CHSVDVBSM7_MACQ_PRIV_H
#define  _CHSVDVBSM7_MACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsM7_mAcq_Priv::
#include "locals_mAcq.h"

class CHsvDvbsM7_mAcq_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsM7_mAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbsM7_mAcq_Priv,iacqpow);
IHsvDigitalAcquisitionImpl(CHsvDvbsM7_mAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbsM7_mAcq_Priv);

public:
CHsvDvbsM7_mAcq_Priv():i__iacqpow(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsM7_mAcq_Priv::func,replace,(char *)name,this)
