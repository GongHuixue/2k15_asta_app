#ifndef  _CHSVDVBCINSTALLATION_MFULL_PRIV_H
#define  _CHSVDVBCINSTALLATION_MFULL_PRIV_H 
...
#define CLASSSCOPE CHsvDvbCInstallation_mfull_Priv::
#include "locals_mfull.h"

class CHsvDvbCInstallation_mfull_Priv : public CTCMwBase
{
public:
virtual ~CHsvDvbCInstallation_mfull_Priv();
...
//Provided interfaces
private:
IHsvSdmControlNotifyExImpl(CHsvDvbCInstallation_mfull_Priv,ifctrlN);
IEnableImpl(CHsvDvbCInstallation_mfull_Priv,ifena);
IHsvStreamNotifyImpl(CHsvDvbCInstallation_mfull_Priv,ifstrapiN);
IHsvDigitalScanImpl(CHsvDvbCInstallation_mfull_Priv,ifull);
IHsvFrontEndApiNotifyImpl(CHsvDvbCInstallation_mfull_Priv,ifullfeN);
IHsvPowerImpl(CHsvDvbCInstallation_mfull_Priv,ifullpow);
public:
...
private:
Pumpdefines(CHsvDvbCInstallation_mfull_Priv);

public:
CHsvDvbCInstallation_mfull_Priv():i__ifctrlN(this),i__ifena(this),i__ifstrapiN(this),i__ifull(this),i__ifullfeN(this),i__ifullpow(this)
{
ifctrlN	=	&i__ifctrlN;
ifena	=	&i__ifena;
ifstrapiN	=	&i__ifstrapiN;
ifull	=	&i__ifull;
...
#define ifullN_iPresent() (ifullN.Present())
...
#define ifullN_OnEvent(event)	ifullN->OnEvent(event)
...
#define insN_EventServiceFound IHsvInstallationNotify_EventServiceFound
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbCInstallation_mfull_Priv::func,replace,(char *)name,this)
...
#define sysset_GetExtractScanResult() sysset->GetExtractScanResult()
#define sysset_SetUpdatedONID(aiONID) sysset->SetUpdatedONID(aiONID)
#define sysset_SetUpdatedTsID(aiTSID) sysset->SetUpdatedTsID(aiTSID)
#define sysset_SetUpdatedChannelName(Name) sysset->SetUpdatedChannelName(Name)
#define sysset_SetUpdatedSymbolRate(aiSymRate) sysset->SetUpdatedSymbolRate(aiSymRate)
