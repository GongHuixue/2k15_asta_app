#ifndef  _CHSVDVBSTRICOLOR_MSORT_PRIV_H
#define  _CHSVDVBSTRICOLOR_MSORT_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsTricolor_mSort_Priv::
#include "locals_mSort.h"

class CHsvDvbsTricolor_mSort_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsTricolor_mSort_Priv();
...
//Provided interfaces
private:
IHsvSortingImpl(CHsvDvbsTricolor_mSort_Priv,itricolorsort);
IHsvPowerImpl(CHsvDvbsTricolor_mSort_Priv,isortpow);
public:
...
private:
Pumpdefines(CHsvDvbsTricolor_mSort_Priv);

public:
CHsvDvbsTricolor_mSort_Priv():i__itricolorsort(this),i__isortpow(this)
{
itricolorsort	=	&i__itricolorsort;
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsTricolor_mSort_Priv::func,replace,(char *)name,this)
