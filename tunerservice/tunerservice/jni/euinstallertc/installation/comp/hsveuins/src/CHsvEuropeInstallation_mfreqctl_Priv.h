#ifndef  _CHSVEUROPEINSTALLATION_MFREQCTL_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MFREQCTL_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mfreqctl_Priv::
#include "locals_mfreqctl.h"

class CHsvEuropeInstallation_mfreqctl_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mfreqctl_Priv();
...
//Provided interfaces
private:
IHsvInstallationFrequencyControlImpl(CHsvEuropeInstallation_mfreqctl_Priv,freqctl);
IHsvPowerImpl(CHsvEuropeInstallation_mfreqctl_Priv,imfreqctlpow);
public:
...
public:
CHsvEuropeInstallation_mfreqctl_Priv():i__freqctl(this),i__imfreqctlpow(this)
{
freqctl	=	&i__freqctl;
imfreqctlpow	=	&i__imfreqctlpow;
module__init();
params__init();
}
