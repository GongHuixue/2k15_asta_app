#ifndef  _CHSVEUROPEINSTALLATION_MNORSORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MNORSORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mnorsort_Priv::
#include "locals_mnorsort.h"

class CHsvEuropeInstallation_mnorsort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mnorsort_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvEuropeInstallation_mnorsort_Priv,inorpow);
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mnorsort_Priv,inorsort);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mnorsort_Priv);

public:
CHsvEuropeInstallation_mnorsort_Priv():i__inorpow(this),i__inorsort(this)
{
inorpow	=	&i__inorpow;
inorsort	=	&i__inorsort;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mnorsort_Priv::func,replace,(char *)name,this)
