#ifndef  _CHSVDVBSDIGITURK_MACQ_PRIV_H
#define  _CHSVDVBSDIGITURK_MACQ_PRIV_H 
...
#define CLASSSCOPE CHsvDvbsDigiTurk_mAcq_Priv::
#include "locals_mAcq.h"

class CHsvDvbsDigiTurk_mAcq_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsDigiTurk_mAcq_Priv();
...
//Provided interfaces
private:
IHsvPowerImpl(CHsvDvbsDigiTurk_mAcq_Priv,iacqpow);
IHsvDigitalAcquisitionImpl(CHsvDvbsDigiTurk_mAcq_Priv,idataacq);
public:
...
private:
Pumpdefines(CHsvDvbsDigiTurk_mAcq_Priv);

public:
CHsvDvbsDigiTurk_mAcq_Priv():i__iacqpow(this),i__idataacq(this)
{
iacqpow	=	&i__iacqpow;
...
#define iscandata_iPresent() (iscandata.Present())
#define iscandata_GetPtcInfo(ptc)	iscandata->GetPtcInfo(ptc)
#define iscandata_GetInstallationVersion()	iscandata->GetInstallationVersion()
#define iscandata_GetPtcInfoForSdSd(ptc)	iscandata->GetPtcInfoForSdSd(ptc)
#define iscandata_SyncComplete()	iscandata->SyncComplete()
#define isdsddata_iPresent() (isdsddata.Present())
#define isdsddata_GetSDSDData(data)	isdsddata->GetSDSDData(data)
#define isdsddata_GetHomingData(data)	isdsddata->GetHomingData(data)
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsDigiTurk_mAcq_Priv::func,replace,(char *)name,this)
