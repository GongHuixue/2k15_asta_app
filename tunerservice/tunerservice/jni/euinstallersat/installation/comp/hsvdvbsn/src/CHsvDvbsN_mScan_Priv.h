#ifndef  _CHSVDVBSN_MSCAN_PRIV_H
#define  _CHSVDVBSN_MSCAN_PRIV_H 
...
#include <CS2MwBase.h>
class CHsvDvbsN_mScan_Priv;
#define CLASSSCOPE CHsvDvbsN_mScan_Priv::
#include "locals_mScan.h"

class CHsvDvbsN_mScan_Priv : public CS2MwBase
{
public:
virtual ~CHsvDvbsN_mScan_Priv();
...
//Provided interfaces
private:
IHsvDigitalAcquisitionNotifyImpl(CHsvDvbsN_mScan_Priv,idataacqN);
IHsvSatellitePackageInstallationImpl(CHsvDvbsN_mScan_Priv,isvcscan);
IHsvSdmControlNotifyExImpl(CHsvDvbsN_mScan_Priv,isvcscanctrlN);
IHsvDigitalScanDataImpl(CHsvDvbsN_mScan_Priv,isvcscandata);
IHsvPowerImpl(CHsvDvbsN_mScan_Priv,isvcscanpow);
IHsvSatelliteFrontEndNotifyImpl(CHsvDvbsN_mScan_Priv,plfApidvbsN);
public:
...
private:
Pumpdefines(CHsvDvbsN_mScan_Priv);

public:
CHsvDvbsN_mScan_Priv():i__idataacqN(this),i__isvcscan(this),i__isvcscanctrlN(this),i__isvcscandata(this),i__isvcscanpow(this),i__plfApidvbsN(this)
{
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvDvbsN_mScan_Priv::func,replace,(char *)name,this)
