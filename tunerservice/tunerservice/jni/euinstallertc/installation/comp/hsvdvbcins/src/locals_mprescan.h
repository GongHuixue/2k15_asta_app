...
Pump mPreScanPump;
static Pump s__mPreScanPump;
t_DVBCPreScanStatus mDvbcPreScanStatus;
static t_DVBCPreScanStatus s__mDvbcPreScanStatus;
...
void module__init(void){
	...
	mPreScanPump	=	s__mPreScanPump;
	mDvbcPreScanStatus	=	s__mDvbcPreScanStatus;
