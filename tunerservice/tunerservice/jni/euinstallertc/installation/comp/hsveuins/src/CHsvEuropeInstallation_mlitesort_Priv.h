#ifndef  _CHSVEUROPEINSTALLATION_MLITESORT_PRIV_H
#define  _CHSVEUROPEINSTALLATION_MLITESORT_PRIV_H 
...
#define CLASSSCOPE CHsvEuropeInstallation_mlitesort_Priv::
#include "locals_mlitesort.h"

class CHsvEuropeInstallation_mlitesort_Priv : public CTCMwBase
{
public:
virtual ~CHsvEuropeInstallation_mlitesort_Priv();
...
//Provided interfaces
private:
IHsvHybridPresetSortImpl(CHsvEuropeInstallation_mlitesort_Priv,idvbclitesort);
IHsvPowerImpl(CHsvEuropeInstallation_mlitesort_Priv,ilitepow);
public:
...
private:
Pumpdefines(CHsvEuropeInstallation_mlitesort_Priv);

public:
CHsvEuropeInstallation_mlitesort_Priv():i__idvbclitesort(this),i__ilitepow(this)
{
idvbclitesort	=	&i__idvbclitesort;
ilitepow	=	&i__ilitepow;
module__init();
params__init();
}
...
#define pmp_PmpCreateEx( pen, func, replace, name ) m_pfac.PmpCreate(pen,&CHsvEuropeInstallation_mlitesort_Priv::func,replace,(char *)name,this)
